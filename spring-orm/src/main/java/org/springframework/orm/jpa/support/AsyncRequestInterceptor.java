 ...
 */
/**
 * OpenSessionInViewFilter和OpenSessionInViewInterceptor中使用的具有异步Web请求的拦截器。 
 * 确保以下各项：1）启动"可调用处理"时，会话已绑定/未绑定2）如果异步请求超时或发生错误，则关闭会话。 
 * @author  Rossen Stoyanchev @since 3.2.5起
 */
