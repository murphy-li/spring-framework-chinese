 ...
 */
/**
 * Hibernate 5的JtaPlatform SPI的实现，公开了传入的{@link  TransactionManager}，{<@link> UserTransaction}和{@link  TransactionSynchronizationRegistry}引用。 
...
class ConfigurableJtaPlatform implements JtaPlatform {
	 ...
	 */
	/**
	 * 使用给定的JTA TransactionManager和可选的给定UserTransaction创建一个新的ConfigurableJtaPlatform实例。 
	 *  
	 * @param 是JTA TransactionManager参考（必需）
	 * @param 是JTA UserTransaction参考（可选）
	 * @param 是JTA 1.1 TransactionSynchronizationRegistry（可选）
	 */
