 ...
 */
/**
 * 具有用于Hibernate Session处理的方法的Helper类。 
 * 还提供对异常转换的支持。 
...
public abstract class SessionFactoryUtils {
	 ...
	 * 返回{@code  DataSourceUtils.CONNECTION_SYNCHRONIZATION_ORDER-100}以在JDBC连接清除之前执行会话清除（如果有）。 
	 *  
	 * @see  DataSourceUtils＃CONNECTION_SYNCHRONIZATION_ORDER
	 */
	 ...
	 */
	/**
	 * 获取本地的Hibernate FlushMode，在Hibernate 5.0 / 5.1和5.2+之间进行调整。 
	 *  
	 * @param 会话Hibernate会话从
	 * @return  FlushMode获取刷新模式（从不{<@@code> null}）@4.3开始
	 */
	 ...
	 */
	/**
	 * 在给定的Hibernate会话上触发刷新，从而转换常规的{@link  HibernateException}实例以及Hibernate 5.2的{@link  PersistenceException}包装器。 
	 *  
	 * @param 会话要刷新的Hibernate会话
	 * @param 同步此刷新是否由事务同步触发
	 * @throws  DataAccessException，如果刷新失败@4.3.2起
	 */
	 ...
	 */
	/**
	 * 执行Hibernate会话的实际关闭，捕获并记录所有抛出的清除异常。 
	 *  
	 * @param 会话Hibernate会话关闭（可能为{@code  null}）
	 * @see  Session＃close（）
	 */
	 ...
	 */
	/**
	 * 确定给定SessionFactory的数据源。 
	 *  
	 * @param  sessionFactory会话工厂以检查
	 * @return 数据源，如果找不到，则为{@code  null} 
	 * @see  ConnectionProvider
	 */
	@Nullable
