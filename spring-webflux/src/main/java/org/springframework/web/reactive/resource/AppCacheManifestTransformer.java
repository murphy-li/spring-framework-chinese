 ...
 */
/**
 * {@link  ResourceTransformer} HTML5 AppCache清单。 
 ...
 *  </ ul> <p>所有带有".appcache"文件扩展名（或提供给构造函数的扩展名）的文件都将由此类转换。 
 * 哈希是使用appcache清单的内容计算得出的，因此清单中的更改会使浏览器缓存无效。 
 * 这也应适用于引用资源的更改，这些资源的链接也已版本化。 
 *  @author  Rossen Stoyanchev @author  Brian Clozel @since 5.0 
