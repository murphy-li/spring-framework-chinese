 ...
 */
/**
 * 通过委托给{@link  RequestUpgradeStrategy}来处理WebSocket HTTP握手请求的{@code  WebSocketService}实现，该实现可以从类路径中自动检测（无参数构造函数），但也可以显式配置。 
...
public class HandshakeWebSocketService implements WebSocketService, Lifecycle {
	 ...
	 */
	/**
	 * 默认构造函数自动使用基于类路径检测的{@link  RequestUpgradeStrategy}发现。 
	 * 
	 */
	 ...
	 */
	/**
	 * 使用{@link  RequestUpgradeStrategy}的备用构造函数。 
	 *  
	 * @param  upgradeStrategy使用的策略
	 */
	 ...
	 */
	/**
	 * 配置一个谓词以提取{@link  org.springframework.web.server.WebSession WebSession}属性，并使用它们来初始化WebSocket会话。 
	 *  <p>默认情况下不设置此属性，在这种情况下不传递任何属性。 
	 *  
	 * @param 谓词@始于5.1
	 */
	 ...
	 */
	/**
	 * 从{@code  WebSession}属性返回用于初始化WebSocket会话属性的配置谓词。 
	 *  @5.1起
	 */
	@Nullable
