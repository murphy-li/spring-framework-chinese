 ...
 */
/**
 * {@link  org.springframework.web.reactive.HandlerResultHandler HandlerResultHandler}的基类，支持内容协商和对{@code  ReactiveAdapter}注册表的访问。 
...
public abstract class HandlerResultHandlerSupport implements Ordered {
	 ...
	 *  <p>默认情况下设置为{@link  Ordered＃LOWEST_PRECEDENCE}，但是请参阅子类的Javadoc，这可能会更改此默认设置。 
	 *  
	 * @param 订购订单
	 */
	 ...
	 */
	/**
	 * 获取顶级返回值类型的{@code  ReactiveAdapter}。 
	 *  
	 * @return 匹配的适配器，如果没有，则为{<@@code> null}
	 */
	@Nullable
	 ...
	 *  
	 * @param 交换当前请求
	 * @param  producibleTypesSupplier可为当前请求生成的媒体类型
	 * @return 所选媒体类型； 
	 * 如果没有，则{@code  null}
	 */
	@Nullable
