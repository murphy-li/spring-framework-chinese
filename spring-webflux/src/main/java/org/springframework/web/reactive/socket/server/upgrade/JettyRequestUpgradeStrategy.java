 ...
 */
/**
 * 与Jetty一起使用的{@link  RequestUpgradeStrategy}。 
...
public class JettyRequestUpgradeStrategy implements RequestUpgradeStrategy, Lifecycle {
	 ...
	 */
	/**
	 * 配置{@link  WebSocketPolicy}以初始化{@link  WebSocketServerFactory}。 
	 *  
	 * @param  webSocketPolicy WebSocket设置
	 */
	 ...
	 */
	/**
	 * 返回已配置的{@link  WebSocketPolicy}（如果有）。 
	 * 
	 */
	@Nullable
