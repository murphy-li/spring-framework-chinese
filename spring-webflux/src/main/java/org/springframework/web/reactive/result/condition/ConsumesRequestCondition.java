...
public final class ConsumesRequestCondition extends AbstractRequestCondition<ConsumesRequestCondition> {
	 ...
	 */
	/**
	 * 返回：<ul> <li> 0，如果两个条件具有相同数量的表达式<li>如果"this"具有更多或更多特定的媒体类型表达式，则小于0如果<other>具有更多或更多的媒体类型表达式，则<li>大于0更具体的媒体类型表达式</ ul> <p>假定两个实例都是通过{@link  #getMatchingCondition（ServerWebExchange）}获得的，并且每个实例仅包含匹配的可消耗媒体类型表达式，否则为空。 
	 * 
	 */
	@Override
