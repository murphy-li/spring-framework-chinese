 ...
 *  @author  Phillip Webb @author  Rossen Stoyanchev @从4.0开始
 */
public class ExecutorSubscribableChannel extends AbstractSubscribableChannel {
	 ...
	 */
	/**
	 * 创建一个新的{@link  ExecutorSubscribableChannel}实例，在该实例中，消息将在调用者线程中发送。 
	 * 
	 */
	 ...
	 */
	/**
	 * 创建一个新的{@link  ExecutorSubscribableChannel}实例，在该实例中，消息将通过指定的执行者发送。 
	 *  
	 * @param 执行程序用于发送消息的执行程序，或用于在调用方线程中执行的{@code  null}。 
	 * 
	 */
