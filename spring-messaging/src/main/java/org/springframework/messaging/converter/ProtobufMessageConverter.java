 ...
 */
/**
 * 一个{@code  MessageConverter}，它使用<ahref="https://developers.google.com/protocol-来读写{@link com.google.protobuf.Message com.google.protobuf.Messages}缓冲区/"> Google协议缓冲区</a>。 
 *  <p>要生成{@code  Message} Java类，您需要安装{@code  protoc}二进制文件。 
 *  <p>默认情况下，此转换器通过正式的{@code "com.google.protobuf：protobuf-java"}库支持{@code "application / x-protobuf"}。 
 * 官方{@code "com.google.protobuf：protobuf-java-util"} 3.x可以支持<p> {<@code>"application / json"}，建议使用3.3或更高版本。 
 *  @author  Parviz Rozikov @author  Rossen Stoyanchev @5.2.2起
 */
public class ProtobufMessageConverter extends AbstractMessageConverter {
	 ...
	 */
	/**
	 * protobuf {@code  application / x-protobuf}的mime类型。 
	 * 
	 */
	 ...
	 */
	/**
	 * 构造器的默认实例为{@link  ExtensionRegistry}。 
	 * 
	 */
	 ...
	 */
	/**
	 * 具有给定的{@code  ExtensionRegistry}的构造方法。 
	 * 
	 */
