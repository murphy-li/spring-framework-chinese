 ...
 */
/**
 * 一个{@link  javax.websocket.server.ServerEndpointConfig.Configurator}，用于通过Spring初始化{@link  ServerEndpoint}注释的类。 
 *  <p> <pre class ="code"> @ServerEndpoint（value ="/ echo"，configurator = SpringConfigurator.class）公共类EchoEndpoint {// ...} </ pre> @author  Rossen Stoyanchev @since 4.0 
 * @see  ServerEndpointExporter
 */
