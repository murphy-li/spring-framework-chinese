 ...
 */
/**
 * 通过Jetty WebSocket API以编程方式向WebSocket服务器发起WebSocket请求。 
 *  <p>从4.1开始，该类实现{@link 生命周期}而不是{@link  org.springframework.context.SmartLifecycle}。 
 * 使用{@link  org.springframework.web.socket.client.WebSocketConnectionManager WebSocketConnectionManager}来自动启动WebSocket连接。 
...
public class JettyWebSocketClient extends AbstractWebSocketClient implements Lifecycle {
	 ...
	 */
	/**
	 * 默认构造函数，用于创建{@link  org.eclipse.jetty.websocket.client.WebSocketClient}的实例。 
	 * 
	 */
	 ...
	 */
	/**
	 * 接受现有{@link  org.eclipse.jetty.websocket.client.WebSocketClient}实例的构造方法。 
	 * 
	 */
	 ...
	 */
	/**
	 * 通过{@link  WebSocketSession＃getPrincipal（）}返回用户以使其可用。 
	 * 默认情况下，此方法返回{@code  null}
	 */
	@Nullable
