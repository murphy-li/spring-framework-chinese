 ...
 */
/**
 * 基于JSR-356的服务器（包括Tyrus作为其WebSocket引擎）之上的{@code  RequestUpgradeStrategy}实现的基类。 
 *  <p>可与Tyrus 1.11（WebLogic 12.2.1）和Tyrus 1.12（GlassFish 4.1.1）一起使用。 
 *  @author  Rossen Stoyanchev @author  Brian Clozel @author  Juergen Hoeller @始于4.1 
 * @see  <a href="https://tyrus.java.net/"> Tyrus项目</a>
 */
