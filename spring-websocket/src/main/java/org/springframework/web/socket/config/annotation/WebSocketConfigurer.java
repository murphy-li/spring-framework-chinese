 ...
 */
/**
 * 定义回调方法，以通过{@link  org.springframework.web.socket.config.annotation.EnableWebSocket @EnableWebSocket}配置WebSocket请求处理。 
...
public interface WebSocketConfigurer {
	 ...
	 */
	/**
	 * 根据需要注册{@link  WebSocketHandler WebSocketHandlers}，包括SockJS后备选项。 
	 * 
	 */
