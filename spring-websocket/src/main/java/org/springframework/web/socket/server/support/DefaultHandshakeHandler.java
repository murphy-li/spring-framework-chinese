 ...
 */
/**
 * 默认的{@link  org.springframework.web.socket.server.HandshakeHandler}实现，扩展了{@link  AbstractHandshakeHandler}并具有特定于Servlet的初始化支持。 
 * 有关受支持的服务器等的详细信息，请参见{@link  AbstractHandshakeHandler}的javadoc。 
