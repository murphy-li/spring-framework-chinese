 ...
 */
/**
 * 与Jetty 9.4 WebSocket API一起使用的{@link  WebSocketSession}。 
...
public class JettyWebSocketSession extends AbstractWebSocketSession<Session> {
	 ...
	 *  
	 * @param 属性来自HTTP握手的属性，可与WebSocket会话关联
	 */
	 ...
	 */
	/**
	 * 创建一个与给定用户关联的新{@link  JettyWebSocketSession}实例。 
	 *  
	 * @param 属性来自HTTP握手的属性，以与WebSocket会话关联； 
	 * 提供的属性被复制，不使用原始地图。 
	 *  
	 * @param  user与会话关联的用户； 
	 * 如果{@code  null}，我们将退回可通过{@link  org.eclipse.jetty.websocket.api.Session＃getUpgradeRequest（）}访问的用户
	 */
