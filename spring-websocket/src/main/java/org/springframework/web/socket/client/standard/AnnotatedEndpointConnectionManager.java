 ...
 */
/**
 * 赋予URI的WebSocket连接管理器（带有{@link  javax.websocket.ClientEndpoint}的终结点）通过{@link  #start（）}和{@link ＃ stop（）}方法。 
...
public class AnnotatedEndpointConnectionManager extends ConnectionManagerSupport implements BeanFactoryAware {
	 ...
	 */
	/**
	 * 设置一个{@link  TaskExecutor}来打开连接。 
	 * 默认情况下，使用{@link  SimpleAsyncTaskExecutor}。 
	 * 
	 */
