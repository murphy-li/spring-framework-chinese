 ...
 */
/**
 * 使用{@link  org.springframework.web.client.RestTemplate RestTemplate}的{@code  XhrTransport}实现。 
...
public class RestTemplateXhrTransport extends AbstractXhrTransport {
	 ...
	 */
	/**
	 * 配置{@code  TaskExecutor}以执行XHR接收请求。 
	 *  <p>默认情况下，配置{@link  org.springframework.core.task.SimpleAsyncTaskExecutor SimpleAsyncTaskExecutor}会在每次传输连接时创建一个新线程。 
	 * 
	 */
	 ...
	 */
	/**
	 * 一个简单的ResponseExtractor，将正文读取为String。 
	 * 
	 */
	 ...
	 */
	/**
	 * 添加标题和（可选）字符串内容的RequestCallback。 
	 * 
	 */
	 ...
	 */
	/**
	 * 将HTTP响应的主体拆分为SockJS框架，并将其委托给{@link  XhrClientSockJsSession}。 
	 * 
	 */
