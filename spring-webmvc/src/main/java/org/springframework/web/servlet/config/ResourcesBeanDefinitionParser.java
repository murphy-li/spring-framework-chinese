 ...
 */
/**
 * {@link  org.springframework.beans.factory.xml.BeanDefinitionParser}解析{@code  resources}元素以注册{@link  ResourceHttpRequestHandler}并注册{@link  SimpleUrlHandlerMapping}进行映射资源请求和一个{@link  HttpRequestHandlerAdapter}。 
 * 还将使用{@link  ResourceResolver ResourceResolvers}和{@link  ResourceTransformer ResourceTransformers}创建资源处理链。 
 *  @author 基思·唐纳德@author 杰里米·格莱尔@author  Brian Clozel @since 3.0.4
 */
