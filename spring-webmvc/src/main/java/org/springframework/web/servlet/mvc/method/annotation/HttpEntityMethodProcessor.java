 ...
 */
/**
 * 解析{@link  HttpEntity}和{@link  RequestEntity}方法参数值，还处理{@link  HttpEntity}和{@link  ResponseEntity}返回值。 
 *  <p> {<@link> HttpEntity}返回类型具有特定的用途。 
 * 因此，应在支持任何以{@code  @ModelAttribute}或{@code  @ResponseBody}注释的任何返回值类型的处理程序之前配置此处理程序，以确保它们不会接管。 
 *  @author  Arjen Poutsma @author  Rossen Stoyanchev @author  Brian Clozel @始于3.1
 */
public class HttpEntityMethodProcessor extends AbstractMessageConverterMethodProcessor {
	 ...
	 * 为了处理{@code  ResponseEntity}，请考虑还提供一个{@code  ContentNegotiationManager}。 
	 * 
	 */
	 ...
	 * 适用于解析{@code  HttpEntity}和处理{@code  ResponseEntity}，而无需{@code  Request〜}或{@code  ResponseBodyAdvice}。 
	 * 
	 */
	public HttpEntityMethodProcessor(List<HttpMessageConverter<?>> converters,
	 ...
	 */
	/**
	 * 完整的构造函数，用于解析{@code  HttpEntity}和处理{@code  ResponseEntity}。 
	 * 
	 */
	public HttpEntityMethodProcessor(List<HttpMessageConverter<?>> converters,
