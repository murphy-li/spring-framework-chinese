 ...
 */
/**
 * 在MVC名称空间BeanDefinitionParsers中使用的便捷方法。 
 *  @author 罗森·斯托扬切夫@author  Brian Clozel @since 3.1
 */
public abstract class MvcNamespaceUtils {
	 ...
	 */
	/**
	 * 除非已注册，否则将别名添加到现有的知名名称或在该知名名称下注册{@link  UrlPathHelper}的新实例。 
	 *  
	 * @return 与此{@link  UrlPathHelper}实例的RuntimeBean引用
	 */
	 ...
	 */
	/**
	 * 除非已注册，否则将别名添加到现有的知名名称或在该知名名称下注册{@link  PathMatcher}的新实例。 
	 *  
	 * @return 与此{@link  PathMatcher}实例的RuntimeBean引用
	 */
	 ...
	 */
	/**
	 * 除非已经注册，否则以众所周知的名称注册{@link  HttpRequestHandlerAdapter}。 
	 * 
	 */
	 ...
	 */
	/**
	 * 除非已经注册，否则以众所周知的名称注册{@link  SimpleControllerHandlerAdapter}。 
	 * 
	 */
	 ...
	 */
	/**
	 * 除非已经注册，否则以众所周知的名称注册{@code  Map <String，CorsConfiguration>}（映射为{@code  CorsConfiguration}）。 
	 * 如果提供了非空的CORS配置，则可以更新Bean定义。 
	 *  
	 * @return 与此{@code  Map <String，CorsConfiguration>}实例的RuntimeBean引用
	 */
	 ...
	 */
	/**
	 * 除非已经注册，否则以众所周知的名称注册{@link  HandlerMappingIntrospector}。 
	 * 
	 */
	 ...
	 */
	/**
	 * 查找由{@code 注解驱动的}元素创建或注册的{@code  ContentNegotiationManager} bean。 
	 *  
	 * @return 一个bean定义，bean引用，或者{@code  null}（如果未定义）
	 */
	@Nullable
