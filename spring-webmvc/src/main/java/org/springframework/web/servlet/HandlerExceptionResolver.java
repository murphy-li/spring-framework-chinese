 ...
 */
/**
 * 由对象实现的接口，可以解决在处理程序映射或执行期间抛出的异常，在典型情况下为错误视图。 
 * 实现者通常在应用程序上下文中注册为bean。 
 *  <p>错误视图类似于JSP错误页面，但是可以与任何类型的异常一起使用，包括任何检查到的异常，并且可能具有特定处理程序的细粒度映射。 
...
public interface HandlerExceptionResolver {
	 ...
	 *  <p>返回的{@code  ModelAndView}可以为{@link  plain ModelAndView＃isEmpty（）empty}，以指示异常已成功解决，但不应呈现任何视图，例如通过设置状态码。 
	 *  
	 * @param 请求当前HTTP请求
	 * @param 响应当前HTTP响应
	 * @param 处理程序执行的处理程序； 
