...
final class DefaultEntityResponseBuilder<T> implements EntityResponse.Builder<T> {
	 ...
	 */
	/**
	 * 从给定的对象返回一个新的{@link  EntityResponse.Builder}。 
	 * 
	 */
	 ...
	 */
	/**
	 * 从给定的对象和类型引用返回一个新的{@link  EntityResponse.Builder}。 
	 * 
	 */
	 ...
	 */
	/**
	 * 同步主体的默认{@link  EntityResponse}实现。 
	 * 
	 */
	 ...
	 */
	/**
	 * 异步{@link  CompletionStage}主体的{@link  EntityResponse}实现。 
	 * 
	 */
