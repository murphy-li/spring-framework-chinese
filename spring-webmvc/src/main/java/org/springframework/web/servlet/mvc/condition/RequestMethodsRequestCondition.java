...
public final class RequestMethodsRequestCondition extends AbstractRequestCondition<RequestMethodsRequestCondition> {
	 ...
	 * 如果条件为空（除非请求方法为HTTP OPTIONS），具有匹配请求方法的新条件，则
	 * @param 请求当前请求
	 * @return 相同的实例； 
	 ...
	 */
	/**
	 * 返回：<ul> <li> 0，如果两个条件包含相同数量的HTTP请求方法<li>如果"this"实例具有HTTP请求方法但"other"不大于0，则小于0 "其他"具有HTTP请求方法，但"此"没有</ ul> <p>假定两个实例都是通过{@link  #getMatchingCondition（HttpServletRequest）}获得的，因此每个实例都包含匹配项仅HTTP请求方法，否则为空。 
	 * 
	 */
	@Override
