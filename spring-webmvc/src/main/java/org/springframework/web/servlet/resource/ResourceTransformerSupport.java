 ...
 *  @author  Brian Clozel @author  Rossen Stoyanchev @author  Juergen Hoeller @始于4.1
 */
public abstract class ResourceTransformerSupport implements ResourceTransformer {
	 ...
	 *  
	 * @param  resourcePath需要重写的资源的路径
	 * @param 请求当前请求
	 * @param 资源正在转换的资源
	 * @param  TranslatorChain转换器链
	 * @return 解析的URL，或{@code }（如果无法解析）
	 */
	@Nullable
