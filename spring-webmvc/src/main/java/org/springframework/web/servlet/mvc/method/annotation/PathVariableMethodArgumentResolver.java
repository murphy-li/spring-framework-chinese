 ...
 * 然后，假设已注册了合适的{@link 转换器}或{@link  PropertyEditor}，则通过类型转换将该值转换为{@link  Map}。 
 *  <p>调用{@link  WebDataBinder}，以将类型转换应用于尚未与方法参数类型匹配的解析路径变量值。 
 *  @author  Rossen Stoyanchev @author  Arjen Poutsma @author 于尔根·霍勒（Juergen Hoeller）@从3.1开始
 */
