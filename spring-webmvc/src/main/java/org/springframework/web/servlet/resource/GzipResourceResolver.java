 ...
 */
/**
 * 一个{@code  ResourceResolver}委托给链来定位资源，然后尝试查找扩展名为".gz"的变体。 
 *  <p>仅当"Accept-Encoding"请求标头包含值"gzip"（表示客户端接受gzip压缩的响应）时，解析程序才会参与。 
 *  @author  Jeremy Grelle @author  Rossen Stoyanchev @author  Sam Brannen @从4.1开始不推荐使用，从5.1开始，建议使用{@link  EncodedResourceResolver}
 */
@Deprecated
