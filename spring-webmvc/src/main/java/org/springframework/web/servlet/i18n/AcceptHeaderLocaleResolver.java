 ...
 */
/**
 * {@link  LocaleResolver}实现，仅使用HTTP请求的"accept-language"标头中指定的主要语言环境（即客户端浏览器发送的语言环境，通常是客户端OS的语言环境）。 
 *  <p>注意：不支持{@code  setLocale}，因为只能通过更改客户端的语言环境设置来更改accept标头。 
 *  @author  Juergen Hoeller @author  Rossen Stoyanchev @2003年2月27日
 * @see  javax.servlet.http.HttpServletRequest＃getLocale（）
 */
public class AcceptHeaderLocaleResolver implements LocaleResolver {
	 ...
	 */
	/**
	 * 配置受支持的语言环境，以检查通过{@link  HttpServletRequest＃getLocales（）}确定的请求语言环境。 
	 * 如果未配置，则使用{@link  HttpServletRequest＃getLocale（）}。 
	 *  
	 * @param 语言环境自4.3起支持的语言环境
	 */
	 ...
	 */
	/**
	 * 如果请求没有"Accept-Language"标头，则将固定的默认语言环境配置为回退。 
	 *  <p>在没有"Accept-Language"标头的情况下，默认情况下不设置此属性，将使用服务器的默认语言环境，如{@link  HttpServletRequest＃getLocale（）}中所定义。 
	 *  
	 * @param  defaultLocale从4.3开始使用的默认语言环境
	 */
