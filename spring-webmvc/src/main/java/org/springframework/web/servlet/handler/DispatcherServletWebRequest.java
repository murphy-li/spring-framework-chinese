 ...
 */
/**
 * 知道{@link  org.springframework.web.servlet.DispatcherServlet}的请求上下文的{@link  ServletWebRequest}子类，例如由配置的{@link  org.springframework.web确定的语言环境.servlet.LocaleResolver}。 
...
public class DispatcherServletWebRequest extends ServletWebRequest {
	 ...
	 */
	/**
	 * 为给定请求创建一个新的DispatcherServletWebRequest实例。 
	 *  
	 * @param 请求当前HTTP请求
	 */
