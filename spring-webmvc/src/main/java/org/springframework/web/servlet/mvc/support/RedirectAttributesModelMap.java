 ...
 * 还提供了存储Flash属性的位置，因此它们可以在重定向中幸存下来，而无需嵌入重定向URL中。 
...
public class RedirectAttributesModelMap extends ModelMap implements RedirectAttributes {
	...
	/**
	 * 没有DataBinder的默认构造函数。 
	 * 通过{@link  #toString（）}将属性值转换为String。 
	 * 
	 */
	 ...
	 */
	/**
	 * {@inheritDoc} <p>在添加属性值之前将其格式化为字符串。 
	 * 
	 */
	@Override
	 ...
	 */
	/**
	 * {@inheritDoc} <p>每个属性值在添加前都格式化为字符串。 
	 * 
	 */
	@Override
	 ...
	 */
	/**
	 * {@inheritDoc} <p>每个属性值在合并之前都格式化为String。 
	 * 
	 */
	@Override
