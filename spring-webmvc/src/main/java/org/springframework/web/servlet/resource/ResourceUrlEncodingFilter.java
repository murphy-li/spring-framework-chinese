 ...
 */
/**
 * 过滤器包装{@link  HttpServletResponse}并覆盖其{@link  HttpServletResponse＃encodeURL（String）encodeURL}方法，以便将内部资源请求URL转换为公共URL路径以供外部使用。 
 *  @author  Jeremy Grelle @author  Rossen Stoyanchev @author  Sam Brannen @author  Brian Clozel @始于4.1
 */
public class ResourceUrlEncodingFilter extends GenericFilterBean {
	 ...
	 */
	/**
	 * 运行时异常足够远（到达ResourceUrlProviderExposedInterceptor），可以将其重新抛出为ServletRequestBindingException以产生400响应。 
	 * 
	 */
