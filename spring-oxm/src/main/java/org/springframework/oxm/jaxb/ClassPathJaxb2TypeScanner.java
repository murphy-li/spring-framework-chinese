 ...
 */
/**
 * {@link  Jaxb2Marshaller}的帮助程序类，它扫描给定的程序包以标记有JAXB2注解的类。 
 *  @author  Arjen Poutsma @author  Juergen Hoeller @author  David Harrigan @author  Biju Kunjummen @从3.1.1开始
 * @see  #scanPackages（）
 */
class ClassPathJaxb2TypeScanner {
	 ...
	 * 扫描软件包以查找带有JAXB2注解的类。 
	 *  
	 * @throws  UncategorizedMappingException发生错误的情况
	 */
