...
/**
 * 表示一个简单的属性或字段引用。 
 *  @author 安迪·克莱门特（Andy Clement）@author 于尔根·霍勒（Juergen Hoeller）@author 克拉克·杜普利琴（Clark Duplichien）@自3.0
 */
public class PropertyOrFieldReference extends SpelNodeImpl {
	 ...
	 *  
	 * @return 属性的值
	 * @throws  EvaluationException如果访问该属性有任何问题或找不到它
	 */
	 ...
	 *  
	 * @param  contextObject尝试对其进行属性访问的对象
