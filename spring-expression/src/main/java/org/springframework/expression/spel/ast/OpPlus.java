 ...
 */
/**
 * 加号运算符将：<ul> <li>添加数字<li>连接字符串</ ul> <p>它可用作数字的一元运算符。 
 * 当操作数类型不同（double + int = double）时，将执行标准升级。 
 * 对于其他选项，它取决于已注册的重载程序。 
 *  @author 安迪·克莱门特（Andy Clement）@author 于尔根·霍勒（Juergen Hoeller）@author 伊沃·史密德（Ivo Smid）@author 乔瓦尼·达洛（Giovanni Dall'Oglio Risso）@since 3.0
 */
public class OpPlus extends Operator {
	 ...
	 * @param 值将转换为类型的值
	 * @param 状态表达式状态
	 * @return  {@code  TypedValue}实例转换为{@code  String}
	 */
	 ...
	 */
	/**
	 * 遍历可能合并字符串的节点树，然后将它们全部附加到同一（在堆栈上）StringBuilder。 
	 * 
	 */
