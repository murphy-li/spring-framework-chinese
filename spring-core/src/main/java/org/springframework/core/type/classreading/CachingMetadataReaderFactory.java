 ...
 */
/**
 * 缓存{@link  MetadataReaderFactory}接口的实现，每个Spring {@link  Resource}句柄（即每个".class"文件）缓存{@link  MetadataReader}实例。 
 *  @author  Juergen Hoeller @author  Costin Leau @从2.5开始
 */
public class CachingMetadataReaderFactory extends SimpleMetadataReaderFactory {
	...
	/**
	 * MetadataReader缓存：本地的或在ResourceLoader级别共享的。 
	 * 
	 */
	@Nullable
	 ...
	 */
	/**
	 * 使用本地资源缓存为默认的类加载器创建一个新的CachingMetadataReaderFactory。 
	 * 
	 */
	 ...
	 */
	/**
	 * 使用本地资源缓存为给定的{@link  ClassLoader}创建一个新的CachingMetadataReaderFactory。 
	 *  
	 ...
	 */
	/**
	 * 为给定的{@link  ResourceLoader}创建一个新的CachingMetadataReaderFactory，如果支持，则使用共享资源缓存，否则使用本地资源缓存。 
	 *  
	 * @param  resourceLoader要使用的Spring ResourceLoader（也确定要使用的ClassLoader）
	 * @see  DefaultResourceLoader＃getResourceCache
	 */
	 ...
	 *  <p>本地高速缓存的默认值为256，而共享高速缓存通常不受限制。 
	 * 即使{@link  ResourceLoader}支持共享资源缓存，此方法也将强制执行本地资源缓存。 
	 * 
	 */
	 ...
	 */
	/**
	 * 清除本地MetadataReader缓存（如果有），以删除所有缓存的类元数据。 
	 * 
	 */
