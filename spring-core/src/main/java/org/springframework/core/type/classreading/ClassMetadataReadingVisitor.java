 ...
 */
/**
 * ASM类访问者，该访问者仅查找类名和实现的类型，并通过{@link  org.springframework.core.type.ClassMetadata}接口将其公开。 
 *  @author  Rod Johnson @author  Costin Leau @author  Mark Fisher @author  Ramnivas Laddad @author  Chris Beams @since 2.5 @deprecated从Spring Framework 5.2开始，此包中的此类和相关类具有已由{@link  SimpleAnnotationMetadataReadingVisitor}和相关类替换，以供框架内部使用。 
 * 
 */
@Deprecated
