 ...
 */
/**
 * 包装Netty {@link  ByteBuf}的{@code  DataBuffer}接口的实现。 
 * 通常用{@link  NettyDataBufferFactory}构造。 
...
public class NettyDataBuffer implements PooledDataBuffer {
	 ...
	 */
	/**
	 * 根据给定的{@code  ByteBuff}创建一个新的{@code  NettyDataBuffer}。 
	 *  
	 * @param  byteBuf缓冲区，此缓冲区基于
	 */
	 ...
	 */
	/**
	 * 从当前写入位置开始，将一个或多个Netty {@link  ByteBuf ByteBufs}写入此缓冲区。 
	 *  
	 * @param  byteBufs将缓冲区写入此缓冲区
	 * @return 此缓冲区
	 */
