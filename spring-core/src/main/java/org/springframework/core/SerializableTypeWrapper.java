 ...
 */
/**
 * 内部实用程序类，可用于获取{@link  java.lang.reflect.Type java.lang.reflect.Types}的包装的{@link  Serializable}变体。 
 *  <p> {<@link> #forField（Field）字段}或{@link  #forMethodParameter（MethodParameter）MethodParameters}可用作可序列化类型的根源。 
 * 另外，常规的{@link  Class}也可以用作源。 
 *  <p>返回的类型将是{@link  Class}或{@link  GenericArrayType}，{<@link> ParameterizedType}，{<@link> TypeVariable}或{<@link > WildcardType}。 
 * 除{@link 类}（这是最终的）之外，对将返回进一步的{@link 类型类型}（例如{@link  GenericArrayType＃getGenericComponentType（）}）的方法的调用将被自动包装。 
 *  @author 菲利普·韦伯（Phillip Webb）@author  Juergen Hoeller @author  Sam Brannen @since 4.0
 */
final class SerializableTypeWrapper {
	 ...
	 */
	/**
	 * 返回{@link  Field＃getGenericType（）}的{@link 可序列化}变体。 
	 * 
	 */
	@Nullable
	 ...
	 */
	/**
	 * 返回{@link  MethodParameter＃getGenericParameterType（）}的{@link 可序列化}变体。 
	 * 
	 */
	@Nullable
	 ...
	 */
	/**
	 * 返回由{@link  TypeProvider}支持的{@link 可序列化的} {@link 类型}。 
	 *  <p>如果类型工件通常在当前运行时环境中不可序列化，则此委托将仅按原样返回原始{@code  Type}。 
	 * 
	 */
	@Nullable
	 ...
	 */
	/**
	 * 一个{@link 可序列化}接口，提供对{@link  Type}的访问。 
	 * 
	 */
	 ...
	 */
	/**
	 * {@link 可序列化的} {@link  InvocationHandler}由代理{@link  Type}使用。 
	 * 提供序列化支持并增强所有返回{@code  Type}或{@code  Type []}的方法。 
	 * 
	 */
	@SuppressWarnings("serial")
	 ...
	 */
	/**
	 * 从{@link 字段}获得的{@link  Type Types}的{@link  TypeProvider}。 
	 * 
	 */
	@SuppressWarnings("serial")
	 ...
	 */
	/**
	 * 从{@link  MethodParameter}获得的{@link  Type Types}的{@link  TypeProvider}。 
	 * 
	 */
	@SuppressWarnings("serial")
	 ...
	 */
	/**
	 * 通过调用无参数方法获得的{@link  Type Types}的{@link  TypeProvider}。 
	 * 
	 */
	@SuppressWarnings("serial")
