 ...
 */
/**
 * {@link  MergedAnnotations}实现，它使用{@link  AnnotationTypeMappings}搜索并调整注释和元注释。 
 *  @author 菲利普·韦伯@5.2
 */
final class TypeMappedAnnotations implements MergedAnnotations {
	 ...
	 */
	/**
	 * {@link  AnnotationsProcessor}用于检测注释是直接存在还是元存在。 
	 * 
	 */
	 ...
	 */
	/**
	 * {@link  AnnotationsProcessor}查找单个{@link  MergedAnnotation}。 
	 * 
	 */
	 ...
	 */
	/**
	 * {@link  AnnotationsProcessor}收集{@link  Aggregate}实例。 
	 * 
	 */
