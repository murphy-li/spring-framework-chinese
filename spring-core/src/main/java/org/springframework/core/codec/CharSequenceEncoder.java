 ...
 */
/**
 * 从{@code  CharSequence}流编码为字节流。 
 *  @author  Sebastien Deleuze @author  Arjen Poutsma @author  Rossen Stoyanchev @从5.0开始
 * @see  StringDecoder
 */
public final class CharSequenceEncoder extends AbstractEncoder<CharSequence> {
	 ...
	 */
	/**
	 * 创建一个仅支持"文本/纯文本"的{@code  CharSequenceEncoder}。 
	 * 
	 */
	 ...
	 */
	/**
	 * 创建一个支持所有MIME类型的{@code  CharSequence Encoder}。 
	 * 
	 */
