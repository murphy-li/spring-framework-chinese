 ...
 */
/**
 * 封装方法参数规范的帮助程序类，即{@link 方法}或{@link 构造函数}以及参数索引和已声明泛型类型的嵌套类型索引。 
 * 用作传递的规范对象。 
 *  <p>从4.2开始，提供了一个{@link  org.springframework.core.annotation.SynthesizingMethodParameter}子类，该子类可以合成具有属性别名的注释。 
 * 该子类尤其用于Web和消息终结点处理。 
 *  @author  Juergen Hoeller @author  Rob Harrop @author  Andy Clement @author  Sam Brannen @author  Sebastien Deleuze @author  Phillip Webb @since 2.0起
 * @see  org.springframework.core.annotation .syntheizingMethodParameter
 */
public class MethodParameter {
	...
	/**
	 * 包含的类。 
	 * 也可以通过重写{@link  #getContainingClass（）}来提供
	 */
	@Nullable
	 ...
	 */
	/**
	 * 为给定方法创建一个新的{@code  MethodParameter}，其嵌套级别为1。 
	 * 
	 * @param 方法该方法为
	 * @param 指定参数的参数parameterIndex参数的索引：-1用于方法返回类型;第一个方法参数为0； 
	 * 第二个方法参数为1，依此类推。 
	 * 
	 */
	 ...
	 */
	/**
	 * 为具有嵌套级别1的给定构造函数创建一个新的MethodParameter。 
	 * 
	 * @param 构造函数构造函数为
	 * @param 指定一个参数parameterIndex参数的索引
	 */
	 ...
	 */
	/**
	 * 内部构造函数，用于创建带有已设置包含类的{@link  MethodParameter}。 
	 *  
	 * @param 可执行文件，用于为
	 * @param  parameterIndex指定参数。 
	 * 参数
	 * @param 的索引containsClass包含类@since 5.2
	 */
	 ...
	 */
	/**
	 * 复制构造函数，基于与原始对象相同的元数据和缓存状态，生成一个独立的MethodParameter对象。 
	 * 
	 * @param  original要从中复制的原始MethodParameter对象
	 */
	...
	/**
	 * 返回包装的带注释的元素。 
	 *  <p>注意：此方法公开在方法/构造函数本身上声明的注释（即，在方法/构造函数级别，而不是参数级别）。 
	 *  
	 * @return 方法或构造方法为AnnotatedElement
	 */
	 ...
	 * 增加此参数的嵌套级别。 
	 *  
	 * @see  #getNestingLevel（）@从5.2开始不推荐使用，而推荐使用{@link  #nested（Integer）}
	 */
	@Deprecated
	 ...
	 * 降低此参数的嵌套级别。 
	 *  
	 * @see  #getNestingLevel（）@从5.2开始不推荐使用，以便保留原始的MethodParameter并在需要嵌套的情况下使用{@link  #nested（Integer）}
	 */
	@Deprecated
	...
	/**
	 * 返回目标类型的嵌套级别（通常为1； 
	 * 例如，在"列表列表"的情况下，1表示嵌套列表，而2表示嵌套列表的元素）。 
	 * 
	 */
	 ...
	 * 设置当前嵌套级别的类型索引。 
	 *  
	 * @param  typeIndex对应的类型索引（或默认类型索引为{@code  null}）
	 * @see  #getNestingLevel（）@自5.2起不推荐使用{@link  #withTypeIndex}
	 */
	@Deprecated
	 ...
	 * 返回当前嵌套级别的类型索引。 
	 *  
	 * @return 相应的类型索引，如果未指定，则为{@code  null}（指示默认类型索引）
	 * @see  #getNestingLevel（）
	 */
	@Nullable
	 ...
	 * 返回指定嵌套级别的类型索引。 
	 *  
	 * @param  nestingLevel嵌套级别，以检查
	 * @return 相应的类型索引； 
	 * 如果未指定，则为{@code  null}（指示默认类型索引）
	 */
	@Nullable
	 ...
	 */
	/**
	 * 返回此{@code  MethodParameter}的变体，该变体指向相同的参数，但嵌套层次更深。 
	 *  @4.3起
	 */
	 ...
	 * 返回此{@code  MethodParameter}的变体，该变体指向相同的参数，但嵌套层次更深。 
	 *  
	 * @param  typeIndex从5.2开始的新嵌套级别的类型索引
	 */
	 ...
	 */
	/**
	 * 返回此方法是否指示不需要的参数：以Java 8的{@link  java.util.Optional}的形式，参数级{@code  Nullable}注释的任何变体（例如from JSR-305或FindBugs注解），或者在Kotlin中使用语言级别的可为空的类型声明或{@code  Continuation}参数。 
	 *  @4.3起
	 */
	 ...
	 */
	/**
	 * 检查此方法参数是否使用{@code  Nullable}注释的任何变体进行注释，例如{@code  javax.annotation.Nullable}或{@code  edu.umd.cs.findbugs.annotations.Nullable}。 
	 * 
	 */
	 ...
	 */
	/**
	 * 返回此{@code  MethodParameter}的变体，该变体指向相同的参数，但在声明{@link  java.util.Optional}时，嵌套层更深。 
	 *  @since 4.3 
	 * @see  #isOptional（）
	 * @see  #nested（）
	 */
	 ...
	 */
	/**
	 * 返回此{@code  MethodParameter}的变体，它引用给定的包含类。 
	 *  
	 * @param  containsClass一个特定的包含类（可能是声明类的子类，例如，替换类型变量）@since 5.2 
	 * @see  #getParameterType（）
	 */
	 ...
	 * 返回此方法参数的包含类。 
	 *  
	 * @return 特定的包含类（可能是声明类的子类），或者只是声明类本身
	 * @see  #getDeclaringClass（）
	 */
	 ...
	 * 返回方法/构造函数参数的通用类型。 
	 *  
	 * @return 参数类型（从不{<@@code> null}）@从3.0开始
	 */
	 ...
	 * 返回方法/构造函数参数的嵌套类型。 
	 *  
	 * @return 参数类型（从不{<@@code> null}）@自3.1起
	 * @see  #getNestingLevel（）
	 */
	 ...
	 * 返回方法/构造函数参数的嵌套泛型类型。 
	 *  
	 * @return 参数类型（从不{<@@code> null}）@自4.2起
	 * @see  #getNestingLevel（）
	 */
	 ...
	 */
	/**
	 * 返回给定类型的方法/构造方法注释（如果有）。 
	 *  
	 * @param 注解键入注解类型以查找
	 * @return 注解对象，如果找不到，则为{@code  null}
	 */
	@Nullable
	 ...
	 */
	/**
	 * 如果参数至少具有一个注释，则返回{@code  true}； 
	 * 如果没有注释，则返回{@code  false}。 
	 *  
	 * @see  #getParameterAnnotations（）
	 */
	 ...
	 * 它仅允许发现在应用程序调用{​​@link  #getParameterName（）}时发生（如果有的话）。 
	 * 
	 */
	 ...
	 * 返回方法/构造函数参数的名称。 
	 *  
	 * @return 参数名称（如果类文件中不包含任何参数名称元数据，或者没有设置{{@link> #initParameterNameDiscovery ParameterNameDiscoverer}开头，则可以为{@code  null}）
	 */
	@Nullable
	 ...
	 */
	/**
	 * 一种模板方法，用于在将给定注释实例返回给调用者之前对其进行后处理。 
	 *  <p>默认实现只是按原样返回给定的注释。 
	 *  
	 * @param 注解即将返回的注解
	 * @return 后处理的注解（或简称为原始注解）@4.2起
	 */
	 ...
	 */
	/**
	 * 一种模板方法，用于在将给定注释数组返回给调用方之前对其进行后处理。 
	 *  <p>默认实现只是按原样返回给定的注释数组。 
	 *  
	 * @param 注释将要返回的注释数组
	 * @return 后处理的注释数组（或简称为原始数组）@4.2
	 */
	 ...
	 *  
	 * @param  methodOrConstructor为
	 * @param  parameterIndex指定参数的方法或构造方法参数索引的@<return>自5.0开始不推荐使用的MethodParameter实例的索引，而推荐使用{@link  #forExecutable}
	 */
	@Deprecated
	 ...
	 * @param  parameterIndex指定参数。 
	 * 参数
	 * @return 的索引，相应的MethodParameter实例，自5.0起
	 */
	 ...
	 *  
	 * @param 参数参数描述符
	 * @return 对应的MethodParameter实例@since 5.0
	 */
	...
	private static class KotlinDelegate {
		 ...
		 */
		/**
		 * 检查指定的{@link  MethodParameter}是否表示可空的Kotlin类型，可选参数（在Kotlin声明中具有默认值）还是在挂起函数中使用的{@code  Continuation}参数。 
		 * 
		 */
