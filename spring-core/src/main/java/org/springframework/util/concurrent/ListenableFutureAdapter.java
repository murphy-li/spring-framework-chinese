 ...
 */
/**
 * 将在S上参数化的{@link  ListenableFuture}修改为在T上参数化的{@code  ListenableFuture}的抽象类。 
 * 所有方法都委托给适配器，其中{@link  #get（）}，{@link  #get（long，java.util.concurrent.TimeUnit）}和{@link  ListenableFutureCallback＃onSuccess（Object）}对被适配者的结果调用{@link  #adapt（Object）}。 
...
public abstract class ListenableFutureAdapter<T, S> extends FutureAdapter<T, S> implements ListenableFuture<T> {
	 ...
	 */
	/**
	 * 使用给定的适配器构建一个新的{@code  ListenableFutureAdapter}。 
	 *  
	 * @param 适应者的未来适应
	 */
