 ...
 * 用于数字转换和解析的其他实用程序方法。 
 *  <p>主要供框架内部使用； 
 * 考虑使用Apache的Commons Lang获得更全面的数字实用程序套件。 
 *  @author  Juergen Hoeller @author  Rob Harrop @自1.1.2起
 */
public abstract class NumberUtils {
	 ...
	 */
	/**
	 * 标准数字类型（所有不可变的）：字节，短整数，整数，长整数，大整数，浮点数，双精度，BigDecimal。 
	 * 
	 */
	 ...
	 *  
	 * @param 数字要转换的数字
	 * @param  targetClass目标类要转换为
	 * @return 转换后的数字
	 * @throws  IllegalArgumentException如果目标类不受支持（即，不包含在标准的Number子类中） JDK）
	 * @see  java.lang.Byte 
	 * @see  java.lang.Short 
	 * @see  java.lang.Integer 
	 * @see  java.lang.Long 
	 ...
	 */
	/**
	 * 返回给定数字作为长值之前，请检查{@code  BigInteger} / {<@code> BigDecimal}长溢出。 
	 *  
	 * @param 编号要转换的数字
	 * @param  targetClass要转换为
	 * @return  long值的目标类，如果可转换而没有溢出
	 * @throws  IllegalArgumentException如果存在溢出
	 * @see  #raiseOverflowException
	 */
	 ...
	 */
	/**
	 * 针对给定的数字和目标类别引发<em>溢出</ em>异常。 
	 *  
	 * @param 数字我们尝试转换的数字
	 * @param  targetClass我们尝试转换为
	 * @throws 的目标类IllegalArgumentException如果发生溢出
	 */
	 ...
	 */
	/**
	 * 使用对应的{@code 解码} / {<@code> valueOf}方法将给定的{@code 文本}解析为给定目标类的{@link  Number}实例。 
	 *  <p>在尝试解析数字之前，请从输入{@code  String}修剪所有空格（前导，尾随和字符之间）。 
	 *  <p>也支持十六进制格式的数字（以"0x"，"0X"或"＃"开头）。 
	 *  
	 * @param 文本文本以将
	 * @param  targetClass转换为目标类以解析为<
	 * @returns>解析后的数字
	 * @throws  IllegalArgumentException如果目标类不受支持（即不是标准Number子类， JDK）
	 * @see 字节#decode 
	 * @see 短#decode 
	 * @see 整数#decode 
	 * @see 长#decode 
	 ...
	 */
	/**
	 * 使用提供的{@link  NumberFormat}将给定的{@code 文本}解析为给定目标类的{@link  Number}实例。 
	 *  <p>在尝试解析数字之前，请修剪输入{@code  String}。 
	 *  
	 * @param 文本将要转换的文本
	 * @param  targetClass目标类解析为
	 * @param  numberFormat {@code  NumberFormat}用于解析（如果{@code  null}，则此方法适用返回{@link  #parseNumber（String，Class）}）
	 * @return 解析的数字
	 * @throws  IllegalArgumentException如果不支持目标类（即，JDK中不包含标准的Number子类）<
	 * @see> java.text.NumberFormat＃parse 
	 * @see  #convertNumberToTargetClass 
	 * @see  #parseNumber（String，Class）
	 */
	 ...
	 */
	/**
	 * 确定给定的{@code  value}字符串是否表示一个十六进制数字，即是否需要传递给{@code  Integer.decode}而不是{@code  Integer.valueOf}，依此类推。 
	 * 
	 */
	 ...
	 */
	/**
	 * 从提供的{@link  String}值中解码{{@link> java.math.BigInteger}。 
	 *  <p>支持十进制，十六进制和八进制表示法。 
	 *  
	 * @see  BigInteger＃BigInteger（String，int）
	 */
