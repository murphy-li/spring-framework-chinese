 ...
 */
/**
 * 与Java 5泛型类型参数一起使用的实用程序。 
 * 主要供框架内部使用。 
 *  @author  Ramnivas Laddad @author  Juergen Hoeller @author 克里斯·比姆斯（Chris Beams）@2.0.7起
 */
public abstract class TypeUtils {
	 ...
	 */
	/**
	 * 根据Java泛型规则，检查是否可以将右侧类型分配给左侧类型。 
	 *  
	 * @param  lhsType目标类型
	 * @param  rhsType应该分配给目标类型的值类型
	 * @return 如果rhs可分配给lhs，则为true
	 */
