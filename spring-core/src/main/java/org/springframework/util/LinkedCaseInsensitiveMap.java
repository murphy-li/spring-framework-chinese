 ...
 */
/**
 * {@link  LinkedHashMap}变体，以不区分大小写的方式存储字符串键，例如，用于结果表中基于键的访问。 
 *  <p>保留键的原始顺序和原始大小写，同时允许在任何情况下都包含，获取和删除呼叫。 
 *  <p> <i>不</ i>不支持{@code  null}键。 
 *  @author  Juergen Hoeller @author  Phillip Webb @从3.0开始
 * @param  <V>值类型
 */
...
public class LinkedCaseInsensitiveMap<V> implements Map<String, V>, Serializable, Cloneable {
	 ...
	 */
	/**
	 * 创建一个新的LinkedCaseInsensitiveMap，根据默认的区域设置（默认为小写）存储不区分大小写的键。 
	 *  
	 * @see  #convertKey（字符串）
	 */
	 ...
	 */
	/**
	 * 创建一个新的LinkedCaseInsensitiveMap，根据给定的区域设置（不区分大小写，默认情况下）存储不区分大小写的键。 
	 *  
	 * @param 语言环境用于不区分大小写的键转换的语言环境
	 * @see  #convertKey（String）
	 */
	 ...
	 */
	/**
	 * 创建一个新的LinkedCaseInsensitiveMap，该包装以给定的初始容量包装{@link  LinkedHashMap}并根据默认的语言环境（默认为小写）存储不区分大小写的键。 
	 *  
	 ...
	 */
	/**
	 * 创建一个新的LinkedCaseInsensitiveMap，该包装以给定的初始容量包装{@link  LinkedHashMap}并根据给定的Locale存储不区分大小写的键（默认情况下为小写）。 
	 *  
	 * @param  initialCapacity初始容量
	 * @param 语言环境用于不区分大小写的键转换的语言环境
	 * @see  #convertKey（String）
	 ...
	 */
	/**
	 * 返回此{@code  LinkedCaseInsensitiveMap}使用的语言环境。 
	 * 用于不区分大小写的密钥转换。 
	 *  @始于4.3.10 
	 * @see  #LinkedCaseInsensitiveMap（Locale）
	 * @see  #convertKey（String）
	 ...
	 *  
	 * @param 将候选条目最老
	 * @return  {@code  true}删除它，{<@code> false}保留它
	 * @see  LinkedHashMap＃removeEldestEntry
	 */
	protected boolean removeEldestEntry(Map.Entry<String, V> eldest) {
		return false;
