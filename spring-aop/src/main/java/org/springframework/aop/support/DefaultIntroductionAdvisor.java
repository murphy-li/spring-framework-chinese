 ...
 */
/**
 * 简单的{@link  org.springframework.aop.IntroductionAdvisor}实现默认情况下适用于任何类。 
 *  @author 罗德·约翰逊@author  Juergen Hoeller @2003年11月11日起
 */
...
public class DefaultIntroductionAdvisor implements IntroductionAdvisor, ClassFilter, Ordered, Serializable {
	 ...
	 */
	/**
	 * 为给定建议创建一个DefaultIntroductionAdvisor。 
	 *  
	 * @param 建议要应用的建议（可以实现{@link  org.springframework.aop.IntroductionInfo}接口）
	 * @see  #addInterface
	 */
	 ...
	 *  
	 * @param 建议咨询应用
	 * @param  IntroductionInfo来描述要引入的接口的IntroductionInfo（可以为{@code  null}）
	 */
