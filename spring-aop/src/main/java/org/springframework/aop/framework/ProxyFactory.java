 ...
 *  @author  Rod Johnson @author  Juergen Hoeller @author  Rob Harrop @2003年3月14日起
 */
...
public class ProxyFactory extends ProxyCreatorSupport {
	 ...
	 *  <p>为单个拦截器创建代理的便捷方法，假设拦截器自己处理所有调用，而不是像远程代理一样委派给目标。 
	 *  
	 ...
	 */
	/**
	 * 为指定的{@code  TargetSource}创建一个ProxyFactory，使代理实现指定的接口。 
	 *  
	 * @param  proxyInterface代理应实现的接口
	 ...
	 *  
	 * @param  classLoader类加载器，用于创建代理（对于低级代理工具的默认设置，其创建者为{@code  null}）
	 * @return 代理对象
	 */
	 ...
	 */
	/**
	 * 为指定的{@code  TargetSource}创建代理，以扩展{@code  TargetSource}的目标类。 
	 *  
	 * @param  targetSource代理应调用的TargetSource 
	 * @return 代理对象
	 */
