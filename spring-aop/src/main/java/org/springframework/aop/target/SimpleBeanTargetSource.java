 ...
 */
/**
 * 简单的{@link  org.springframework.aop.TargetSource}实现，可以从其包含Spring {@link  org.springframework.beans.factory.BeanFactory}中获得指定的目标bean。 
 *  <p>可以获得任何类型的目标bean：单例，作用域或原型。 
 * 通常用于范围豆。 
