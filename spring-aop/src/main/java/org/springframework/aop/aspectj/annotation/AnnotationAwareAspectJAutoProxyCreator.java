 ...
 */
/**
 * {@link  AspectJAwareAdvisorAutoProxyCreator}子类，用于处理当前应用程序上下文以及Spring Advisor中的所有AspectJ注释方面。 
 *  <p>任何由AspectJ注释的类都将被自动识别，并且如果Spring AOP的基于代理的模型能够应用它们，则它们的建议也会被应用。 
 * 这涵盖了方法执行连接点。 
 *  <p>如果使用<aop：include>元素，则仅将名称与包含模式匹配的@AspectJ bean视为定义要用于Spring自动代理的方面。 
...
public class AnnotationAwareAspectJAutoProxyCreator extends AspectJAwareAdvisorAutoProxyCreator {
	 ...
	 *  <p>如果未使用任何<aop：include>元素，则"includePatterns"将为{@code  null}，并且包括所有bean。 
