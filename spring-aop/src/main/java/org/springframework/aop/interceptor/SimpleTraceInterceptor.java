 ...
 */
/**
 * 可以引入链中的简单AOP联盟{@code  MethodInterceptor}可以显示有关已拦截方法调用的详细跟踪信息，以及方法入口和方法出口信息。 
 *  <p>请考虑将{@code  CustomizableTraceInterceptor}用于更高级的需求。 
 *  @author  Dmitriy Kopylenko @author  Juergen Hoeller @从1.2起
 * @see  CustomizableTraceInterceptor
 */
