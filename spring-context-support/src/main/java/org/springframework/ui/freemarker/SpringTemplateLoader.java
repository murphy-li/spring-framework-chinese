 ...
 *  {@link  FreeMarkerConfigurationFactory}用于无法解析为{@link  java.io.File}的任何资源加载器路径。 
 *  @author  Juergen Hoeller @2004年3月14日起
 * @see  FreeMarkerConfigurationFactory＃setTemplateLoaderPath 
 * @see  freemarker.template.Configuration＃setDirectoryForTemplateLoading
 */
public class SpringTemplateLoader implements TemplateLoader {
	 ...
	 *  
	 * @param  resourceLoader使用的Spring ResourceLoader 
	 * @param  templateLoaderPath要使用的模板加载器路径
	 */
