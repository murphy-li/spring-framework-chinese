 ...
 */
/**
 * 在{@link  Cache javax.cache.Cache}实例之上的{@link  org.springframework.cache.Cache}实现。 
...
public class JCacheCache extends AbstractValueAdaptingCache {
	 ...
	 * 创建一个{@code  JCacheCache}实例。 
	 *  
	 * @param  jcache支持JCache缓存实例
	 * @param  allowNullValues是否接受并转换为此缓存的空值
	 */
