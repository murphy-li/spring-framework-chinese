 ...
 *  @author  Juergen Hoeller @自从5.1开始不推荐使用2.0版本，而推荐使用EE 7的{@link  org.springframework.scheduling.concurrent.DefaultManagedTaskExecutor}
 */
@Deprecated
public class DelegatingWork implements Work {
	 ...
	 *  
	 * @param 委托Runnable实现委托给它（可能是一个SchedulingAwareRunnable以获得扩展支持）
	 * @see  org.springframework.scheduling.SchedulingAwareRunnable 
	 * @see  #isDaemon（）
	 */
	 ...
	 */
	/**
	 * 如果可用，此实现将委托给{@link  org.springframework.scheduling.SchedulingAwareRunnable＃isLongLived（）}。 
	 * 
	 */
	@Override
