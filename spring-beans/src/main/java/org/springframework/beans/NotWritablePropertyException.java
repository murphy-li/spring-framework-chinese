 ...
 */
/**
 * 尝试设置不可写的属性的值时引发异常（通常是因为没有setter方法）。 
 *  @author 罗德·约翰逊@author  Alef Arendsen @author  Arjen Poutsma
 */
...
public class NotWritablePropertyException extends InvalidPropertyException {
	 ...
	 * @param  propertyName有问题的属性名称
	 * @param  msg详细消息
	 * @param 可能匹配与无效属性名称紧密匹配的实际bean属性名称的建议
	 */
	 ...
	 */
	/**
	 * 返回与无效属性名称（如果有）非常匹配的实际bean属性名称的建议。 
	 * 
	 */
	@Nullable
