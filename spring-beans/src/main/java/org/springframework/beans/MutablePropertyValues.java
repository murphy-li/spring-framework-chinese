 ...
 *  @author  Rod Johnson @author  Juergen Hoeller @author  Rob Harrop @自2001年5月13日起
 */
...
public class MutablePropertyValues implements PropertyValues, Serializable {
	...
	/**
	 * 深拷贝构造函数。 
	 * 保证PropertyValue引用是独立的，尽管它不能深度复制当前由单个PropertyValue对象引用的对象。 
	 *  
	 * @param 复制要复制的PropertyValues 
	 * @see  #addPropertyValues（PropertyValues）
	 */
	 ...
	 */
	/**
	 * 从地图构造一个新的MutablePropertyValues对象。 
	 *  
	 * @param 原始地图，其属性值由属性名称字符串作为键
	 * @see  #addPropertyValues（Map）
	 */
	 ...
	 */
	/**
	 * 依原样使用给定的PropertyValue对象列表构造一个新的MutablePropertyValues对象。 
	 *  <p>这是用于高级用法方案的构造函数。 
	 * 它不适合典型的程序使用。 
	 *  
	 ...
	 */
	/**
	 * 以原始格式返回基础的PropertyValue对象列表。 
	 * 返回的列表可以直接修改，尽管不建议这样做。 
	 *  <p>这是用于优化访问所有PropertyValue对象的访问器。 
	 * 它不适合典型的程序使用。 
	 * 
	 */
	 ...
	 */
	/**
	 * 将所有给定的PropertyValues复制到该对象中。 
	 * 保证PropertyValue引用是独立的，尽管它不能深度复制当前由单个PropertyValue对象引用的对象。 
	 *  
	 * @param 其他要复制的PropertyValues 
	 * @return ，以便允许在链中添加多个属性值
	 */
	 ...
	 * 添加给定Map中的所有属性值。 
	 *  
	 * @param 其他具有以属性名称为键的属性值的Map，必须是字符串
	 * @return ，以便允许在链中添加多个属性值
	 */
	 ...
	 */
	/**
	 * {@code  addPropertyValue}的重载版本，带有属性名称和属性值。 
	 *  <p>注意：从Spring 3.0开始，我们建议使用更简洁和可链接的变量{@link  #add}。 
	 *  
	 ...
	 */
	/**
	 * 具有属性名称的{@code  removePropertyValue}的重载版本。 
	 *  
	 * @param  propertyName属性名称
	 * @see  #removePropertyValue（PropertyValue）
	 */
	 ...
	 * @return 原始属性值，或者如果没有找到，则{@code  null} @自4.0起
	 * @see  #getPropertyValue（String）
	 * @see  PropertyValue＃getValue（ ）
	 */
	@Nullable
	 ...
	 */
	/**
	 * 在某些处理器在PropertyValue（s）机制之外调用相应的setter方法的意义上，将指定的属性注册为"已处理"。 
	 *  <p>这将导致对指定属性的{@link  #contains}调用返回{@code  true}。 
	 *  
	 * @param  propertyName属性名称。 
	 * 
	 */
