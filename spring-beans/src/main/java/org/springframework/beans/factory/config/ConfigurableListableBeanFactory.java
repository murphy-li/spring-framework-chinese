 ...
 *  <p> {<@link> org.springframework.beans.factory.BeanFactory}的此子接口不能在常规应用程序代码中使用：坚持使用{@link  org.springframework.beans.factory.BeanFactory}或{@link  org.springframework.beans.factory.ListableBeanFactory}用于典型的用例。 
...
public interface ConfigurableListableBeanFactory
	 ...
	 * @throws  NoSuchBeanDefinitionException如果没有给定的bean名称
	 */
	 ...
	 * @throws  NoSuchBeanDefinitionException如果工厂中没有使用给定名称定义的bean
	 */
	 ...
	 *  <p>包括Bean定义名称以及手动注册的单例实例的名称，始终以Bean定义名称排在第一位，类似于特定于类型/注释的Bean名称检索的工作方式。 
	 *  
	 * @return  Bean名称视图的复合迭代器@始于4.1.2 
	 * @see  #containsBeanDefinition 
	 * @see  #registerSingleton 
	 * @see  #getBeanNamesForType 
	 * @see  #getBeanNamesForAnnotation
	 ...
	 * 如果需要，通常在工厂设置结束时调用。 
	 *  
	 * @throws  BeansException如果无法创建一个单例bean。 
