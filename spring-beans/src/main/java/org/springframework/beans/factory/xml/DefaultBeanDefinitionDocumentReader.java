 ...
 *  <p>所需的XML文档的结构，元素和属性名称在该类中进行了硬编码。 
 *  （当然，如果需要产生此格式，可以运行转换）。 
 *  {@code  <beans>}不必是XML文档的根元素：此类将解析XML文件中的所有bean定义元素，而与实际的根元素无关。 
 *  @author  Rod Johnson @author  Juergen Hoeller @author  Rob Harrop @author  Erik Wiersma @2003年12月18日起
 */
public class DefaultBeanDefinitionDocumentReader implements BeanDefinitionDocumentReader {
	 ...
	 * 此方法是XML的其他任何自定义预处理的自然扩展点。 
	 *  <p>默认实现为空。 
	 * 子类可以重写此方法，以将自定义元素转换为标准的Spring bean定义。 
	 ...
	 */
	/**
	 * 在完成处理bean定义之后，最后通过处理任何自定义元素类型来允许XML可扩展。 
