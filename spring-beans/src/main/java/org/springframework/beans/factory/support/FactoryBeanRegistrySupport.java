 ...
 */
/**
 * 支持需要处理{@link  org.springframework.beans.factory.FactoryBean}实例的单例注册表的基类，并与{@link  DefaultSingletonBeanRegistry}的单例管理集成在一起。 
...
public abstract class FactoryBeanRegistrySupport extends DefaultSingletonBeanRegistry {
	 ...
	 * 确定给定FactoryBean的类型。 
	 *  
	 * @param  factoryBean FactoryBean实例以检查
	 ...
	 */
	/**
	 * 如果有缓存形式可用，则获取一个对象以从给定的FactoryBean中公开。 
	 * 快速检查最小同步。 
	 *  
	 ...
	 * 子类可以覆盖它，例如，以应用后处理器。 
	 *  
	 * @param 对象从FactoryBean获得的对象。 
	 *  
	 * @param  beanName bean的名称
	 * @return 公开
	 * @throws 的对象org.springframework.beans.BeansException如果任何后处理失败
	 */
	 ...
	 * @throws  BeansException如果给定的bean无法公开为FactoryBean
	 */
