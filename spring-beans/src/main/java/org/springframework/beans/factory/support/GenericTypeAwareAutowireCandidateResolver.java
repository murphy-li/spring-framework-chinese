 ...
 */
/**
 * 基本{@link  AutowireCandidateResolver}，如果将依赖项声明为通用类型（例如Repository <Customer>），则与候选者的类型执行完全通用的类型匹配。 
 *  <p>这是{@link  org.springframework.beans.factory.annotation.QualifierAnnotationAutowireCandidateResolver}的基类，在此级别提供了所有基于非注释的解析步骤的实现。 
...
public class GenericTypeAwareAutowireCandidateResolver extends SimpleAutowireCandidateResolver
	 ...
	 */
	/**
	 * 将给定的依赖关系类型及其泛型信息与给定的候选bean定义进行匹配。 
	 * 
	 */
