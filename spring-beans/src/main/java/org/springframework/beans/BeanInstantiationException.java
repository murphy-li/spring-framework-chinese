...
public class BeanInstantiationException extends FatalBeanException {
	 ...
	 * 创建一个新的BeanInstantiationException。 
	 *  
	 * @param  ConstructingMethod用于bean构造目的的委托（通常但不一定是静态工厂方法）
	 * @param  msg详细消息
	 * @param 引起根本原因@since 4.3
	 */
	 ...
	 * 返回有问题的构造函数（如果已知）。 
	 *  
	 * @return 所使用的构造函数，如果使用工厂方法或默认实例化，则为{@code  null}（自4.3开始）
	 */
	@Nullable
	 ...
	 * 如果已知，则出于豆构造目的返回委托。 
	 *  
	 * @return 使用中的方法（通常是静态工厂方法），如果是基于构造函数的实例化，则为{@code  null}自4.3起
	 */
	@Nullable
