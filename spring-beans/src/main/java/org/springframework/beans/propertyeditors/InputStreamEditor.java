 ...
 */
/**
 * 单向PropertyEditor可以将文本String转换为{@code  java.io.InputStream}，将给定的String解释为Spring资源位置（例如URL String）。 
 *  <p>支持Spring样式的URL表示法：任何完全限定的标准URL（"file："，"http："等）和Spring的特殊"classpath："伪URL。 
 *  <p>请注意，此类流通常不会被Spring自身关闭！ 
...
public class InputStreamEditor extends PropertyEditorSupport {
	 ...
	 */
	/**
	 * 使用下面的给定ResourceEditor创建一个新的InputStreamEditor。 
	 *  
