 ...
 */
/**
 * 简单工厂，允许在AbstractBeanFactory中测试FactoryBean支持。 
 * 根据是否设置了其singleton属性，它将返回一个singleton或一个原型实例。 
 *  <p>实现InitializingBean接口，因此我们可以检查工厂是否需要此生命周期回调。 
 *  @author  Rod Johnson @author 克里斯·比姆斯（Chris Beams）@2003年10月10日起
 */
public class DummyFactory
	 ...
	 */
	/**
	 * 这是通过从InitializingBean接口调用afterPropertiesSet（）方法来初始化的吗？
	 */
