 ...
 */
/**
 * {@code  DelegatingSmartContextLoader}是{@link  AbstractDelegatingSmartContextLoader}的具体实现，它委托给{@link  GenericXmlContextLoader}（如果类路径中存在Groovy，则委托给{@link  GenericGroovyXmlContextLoader}）和{@link  AnnotationConfigContextLoader}。 
