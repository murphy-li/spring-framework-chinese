 ...
 */
/**
 * 调用{@link  org.springframework.test.context.TestExecutionListener＃beforeTestClass（TestContext）}时，由{@link  EventPublishingTestExecutionListener}发布的{@link  TestContextEvent}。 
