 ...
 */
/**
 * 调用{@link  org.springframework.test.context.TestExecutionListener＃prepareTestInstance（TestContext）}时，由{@link  EventPublishingTestExecutionListener}发布的{@link  TestContextEvent}。 
 *  @author 弗兰克·谢弗勒（Frank Scheffler）@自5.2起
 * @see  org.springframework.test.context.event.annotation.PrepareTestInstance @PrepareTestInstance
 */
