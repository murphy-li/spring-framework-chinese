 ...
 *  @author  Sam Brannen @author  Phillip Webb @since 3.1起
 * @see  ContextConfiguration 
 * @see  SmartContextLoader＃processContextConfiguration（ContextConfigurationAttributes）
 * @see  MergedContextConfiguration
 */
public class ContextConfigurationAttributes {
	 ...
	 */
	/**
	 * 使用默认值构造一个新的{@link  ContextConfigurationAttributes}实例。 
	 *  
	 * @param  declaringClass自{4.3起，显式或隐式声明了声明{@code  @ContextConfiguration}的测试类
	 */
	 ...
	 */
	/**
	 * 为提供的{@link  ContextConfiguration @ContextConfiguration}注释和声明了它的{@link  plain Class测试类}构造一个新的{@link  ContextConfigurationAttributes}实例。 
	 *  
	 * @param  declaringClass声明了{@code  @ContextConfiguration}的测试类
	 * @param  contextConfiguration从中检索属性的注解
	 */
	 ...
	 */
	/**
	 * 为提供的{@link  AnnotationAttributes}（从{@link  ContextConfiguration @ContextConfiguration}注解解析）和声明的{@link  plain类测试类}构造一个新的{@link  ContextConfigurationAttributes}实例。 
	 * 他们。 
	 *  
	 * @param  declaringClass声明了{@code  @ContextConfiguration}的测试类
	 * @param  annAttrs注释属性，从中可以获取属性
	 */
	@SuppressWarnings("unchecked")
	 ...
	 */
	/**
	 * 为声明了{@link  ContextConfiguration @ContextConfiguration}注解及其相应属性的{@link  plain类测试类}构造一个新的{@link  ContextConfigurationAttributes}实例。 
	 *  
	 * @param  declaringClass声明了{@code  @ContextConfiguration}的测试类
	 * @param 定位了通过{@code  @ContextConfiguration}声明的资源位置
	 * @param 类通过{<@code声明的> @ContextConfiguration} 
	 * @param 继承位置通过{@code  @ContextConfiguration} 
	 * @param 初始化程序声明的{@code  InheritLocations}标志，通过{@code  @ContextConfiguration}声明的上下文初始化程序
	 * @param  InheritInitializers通过{@code  @ContextConfiguration} 
	 * @param  contextLoaderClass声明的{@code  InheritInitializers}标志，通过{@code  @ContextConfiguration} 
	 * @throws  IllegalArgumentException声明的{@code  ContextLoader}类{@code  declaringClass}或{@code  contextLoaderClass}为{@code  null}
	 */
	 ...
	 * @param 初始化程序声明的{@code  InheritLocations}标志，通过{@code  @ContextConfiguration}声明的上下文初始化程序
	 * @param  InheritInitializers通过{@code  @ContextConfiguration} 
	 * @param 声明的{@code  InheritInitializers}标志命名上下文层次结构中的级别名称，如果不适用，则命名为{@code  null}（
	 * @param  contextLoaderClass）如果{@code  declaringClass}或{@code  contextLoaderClass}为{@code  null}，则通过{@code  @ContextConfiguration} 
	 * @throws  IllegalArgumentException声明的{@code  ContextLoader}类
	 */
	public ContextConfigurationAttributes(
			Class<?> declaringClass, String[] locations, Class<?>[] classes, boolean inheritLocations,
			Class<? extends ApplicationContextInitializer<?>>[] initializers,
	 ...
	 */
	/**
	 * 获取显式或隐式声明了{@link  ContextConfiguration @ContextConfiguration}注解的{@link  plain类类}。 
	 *  
	 * @return 声明类（永远{<@@code> null}）
	 */
	 ...
	 */
	/**
	 * 设置<em>处理过的</ em>带注释的类，有效地覆盖通过{@link  ContextConfiguration @ContextConfiguration}声明的原始值。 
	 *  
	 * @see  #getClasses（）
	 */
	 ...
	 */
	/**
	 * 获取通过{@link  ContextConfiguration @ContextConfiguration}声明的带注释的类。 
	 *  <p>注意：这是一个可变属性。 
	 * 因此，返回的值可能表示与<em>已处理的</ em>值不匹配，该值与通过{@link  ContextConfiguration @ContextConfiguration}声明的原始值不匹配。 
	 *  
	 * @return 带注释的类（可能为{<em> empty </ em>）
	 * @see  ContextConfiguration＃classes 
	 * @see  #setClasses（Class []）
	 */
	 ...
	 */
	/**
	 * 设置<em>处理过的</ em>资源位置，有效地覆盖通过{@link  ContextConfiguration @ContextConfiguration}声明的原始值。 
	 *  
	 * @see  #getLocations（）
	 */
	 ...
	 *  
	 * @return  {@code  true}如果{@link  #getLocations（）位置}数组不为空
	 * @see  #hasResources（）
	 * @see  #hasClasses（）
	 */
	 ...
	 *  
	 * @return  {@code  true}，如果{@link  #getLocations（）位置}或{@link  #getClasses（）类}数组不为空
	 * @see  #hasLocations（） 
	 * @see  #hasClasses（）
	 */
	 ...
	 *  
	 * @return  {@code  ApplicationContextInitializer}类@自3.2起
	 */
	 ...
	 *  
	 * @return  {@code  InheritInitializers}标志@从3.2开始
	 */
	 ...
	 * @return 上下文层次结构级别的名称； 
	 * 如果不适用，则为{<@@code> null} 
	 * @see  ContextConfiguration＃name（）@3.2.2起
	 */
	@Nullable
	 ...
	 */
	/**
	 * 通过比较两个对象的{@link  plain #getDeclaringClass（）声明类}，{<@link> plain #getLocations（）位置}，{<来确定所提供的对象是否与此{@code  ContextConfigurationAttributes}实例相等。 
	 *  @link> plain #getClasses（）带注释的类}，{<@link> plain #isInheritLocations（）InheritLocations标志}，{<@link> plain #getInitializers（）上下文初始化器类}，{<@link> plain #isInheritInitializers（ ）InheritInitializers标志}和{@link  #getContextLoaderClass（）ContextLoader类}。 
	 * 
	 */
	@Override
	 ...
	 */
	/**
	 * 为此{@code  ContextConfigurationAttributes}实例的所有属性（不包括{@link  plain #getName（）name}）生成唯一的哈希码。 
	 * 
	 */
	@Override
	public int hashCode() {
