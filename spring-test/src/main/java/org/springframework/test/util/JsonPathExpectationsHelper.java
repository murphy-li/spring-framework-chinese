 ...
 */
/**
 * 一个通过JSON路径表达式应用断言的助手类。 
 *  <p>基于<a href="https://github.com/jayway/JsonPath"> JsonPath </a>项目：要求版本为0.9+，强烈建议使用1.1+。 
 *  @author  Rossen Stoyanchev @author  Juergen Hoeller @author  Craig Andrews @author  Sam Brannen @3.2起
 */
public class JsonPathExpectationsHelper {
	 ...
	 */
	/**
	 * 构造一个新的{@code  JsonPathExpectationsHelper}。 
	 *  
	 ...
	 */
	/**
	 * 根据提供的{@code  content}评估JSON路径表达式，并使用给定的{@code  Matcher}声明结果值。 
	 *  
	 * @param 内容JSON内容
	 * @param 匹配器用来声明结果的匹配器
	 */
	 ...
	 */
	/**
	 * {@link  #assertValue（String，Matcher）}的重载变体也接受目标类型的结果值。 
	 * 这对于可靠地匹配数字很有用，例如将整数强制为双精度。 
	 *  
	 * @param 内容JSON内容
	 * @param 匹配器用来声明结果的匹配器
	 * @param  targetType自4.3.3起的结果值的预期类型
	 */
	@SuppressWarnings("unchecked")
	 ...
	 */
	/**
	 * 根据提供的{@code  content}评估JSON路径表达式，并断言结果值为{@link 布尔}。 
	 *  
	 * @param 内容JSON内容@4.2.1起
	 */
	 ...
	 */
	/**
	 * 根据提供的{@code  content}评估JSON路径表达式，并断言结果值是一个数组。 
	 *  
	 * @param 内容JSON内容
	 */
	 ...
	 */
	/**
	 * 根据提供的{@code  content}评估JSON路径表达式，并断言给定路径中存在非null值，可能为空数组或映射。 
	 *  <p>请注意，如果JSON路径表达式不是{@link  plain JsonPath＃isDefinite（）definite}，则此方法断言给定路径的值列表不是<em> empty </ em>。 
	 *  
	 * @param 内容JSON内容
	 */
	 ...
	 */
	/**
	 * 根据提供的{@code  content}评估JSON路径表达式，并断言在给定路径中不存在非null值。 
	 *  <p>请注意，如果JSON路径表达式不是{@link  plain JsonPath＃isDefinite（）definite}，则此方法断言给定路径的值列表为<em> empty </ em>。 
	 *  
	 * @param 内容JSON内容
	 */
	 ...
	 *  <p>有关<em> empty </ em>的语义，请向Javadoc查询{@link  ObjectUtils＃isEmpty（Object）}。 
	 *  
	 * @param 内容JSON内容
	 */
	 ...
	 */
	/**
	 * {@link  #evaluateJsonPath（String）}与目标类型的变体。 
	 * 这对于可靠地匹配数字很有用，例如将整数强制为双精度。 
	 *  
	 * @param 内容，如果评估失败，则根据
	 * @return 评估结果
