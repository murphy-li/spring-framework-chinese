 ...
 *  <p>由于已注册的对象实例在外部实例化和初始化，因此没有连线，bean初始化，生命周期事件，也没有通常与{@link  ApplicationContext管理的bean相关联的预处理和后处理钩子。 
 * 只需简单地查看{@link  StaticListableBeanFactory}。 
...
class StubWebApplicationContext implements WebApplicationContext {
	 ...
	 */
	/**
	 * 返回一个可以初始化{@link  ApplicationContextAware} bean的实例。 
	 * 
	 */
	@Override
	 ...
	 */
	/**
	 * StaticListableBeanFactory的扩展，它实现AutowireCapableBeanFactory以便允许{@link  ApplicationContextAware}单例的bean初始化。 
	 * 
	 */
