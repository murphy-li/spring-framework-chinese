 ...
 */
/**
 * 将{@link  MvcResult}详细信息打印到给定输出流的结果处理程序-例如：{@code  System.out}，{<@code> System.err}，自定义{@code  java。 
 *  io.PrintWriter}等。 
 * <p>此类的实例通常通过{@link 中的{@link  MockMvcResultHandlers＃print print}或{@link  MockMvcResultHandlers＃log log}方法之一进行访问。 
...
public class PrintingResultHandler implements ResultHandler {
	 ...
	 * 受保护的构造函数。 
	 *  
	 * @param 打印机使用{@link  ResultValuePrinter}进行实际写入
	 */
	 ...
	 */
	/**
	 * 通过HandlerExceptionResolver解决的打印异常。 
	 * 
	 */
	 ...
	 */
	/**
	 * 假设{@link  Cookie}实现没有提供自己的{@code  toString（）}，请以易于阅读的形式打印提供的cookie。 
	 *  @4.2起
	 */
