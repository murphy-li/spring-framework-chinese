 ...
 *  <p>通常通过{@link  MockMvcResultMatchers＃jsonPath（String，Object ...）}访问此类的实例。 
 *  @author  Rossen Stoyanchev @author  Craig Andrews @author  Sam Brannen @author  Brian Clozel @自3.2起
 */
public class JsonPathResultMatchers {
	...
	/**
	 * 受保护的构造函数。 
	 *  <p>使用{@link  MockMvcResultMatchers＃jsonPath（String，Object ...）}或{@link  MockMvcResultMatchers＃jsonPath（String，Matcher）}。 
	 *  
	 ...
	 */
	/**
	 * 配置当前的{@code  JsonPathResultMatchers}实例，以验证JSON有效负载是否带有给定前缀。 
	 *  <p>如果为JSON有效负载添加了前缀，请使用此方法，以避免跨站点脚本包含（XSSI）攻击。 
	 *  
	 * @param 为从4.3开始的实际JSON有效负载之前的字符串前缀添加前缀
	 */
	 ...
	 */
	/**
	 * 根据响应内容评估JSON路径表达式，并断言给定路径中存在非null值，可能为空数组或映射。 
	 ...
	 */
	/**
	 * 根据响应内容评估JSON路径表达式，并断言在给定路径中不存在非null值。 
	 ...
	 */
	/**
	 * 根据响应内容评估JSON路径表达式，并断言结果是{@link  String}。 
	 *  @4.2.1起
	 */
	 ...
	 */
	/**
	 * 根据响应内容评估JSON路径表达式，并断言结果是{@link 布尔}。 
	 *  @4.2.1起
	 */
	 ...
	 */
	/**
	 * 根据响应内容评估JSON路径表达式，并断言结果是{@link  Number}。 
	 *  @4.2.1起
	 */
	 ...
	 */
	/**
	 * 根据响应内容评估JSON路径表达式，并断言结果是{@link  java.util.Map}。 
	 *  @4.2.1起
	 */
