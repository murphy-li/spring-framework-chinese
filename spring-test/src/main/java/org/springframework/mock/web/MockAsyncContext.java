...
public class MockAsyncContext implements AsyncContext {
	 ...
	 */
	/**
	 * 默认情况下，即使Servlet API将默认的异步请求超时设置为30秒，它也设置为10000（10秒）。 
	 * 请记住，通过MVC Java配置或XML名称空间进行的全局配置可能会进一步影响超时，并且在{@link  org.springframework.web.context.request.async.DeferredResult DeferredResult}上的每个请求都将覆盖超时或在{@link  org.springframework.web.servlet.mvc.method.annotation.SseEmitter SseEmitter}上。 
	 *  
	 * @param 超时要使用的超时值。 
	 *  
	 * @see  AsyncContext＃setTimeout（long）
