 ...
 * 为了方便起见，公开了{@link  #setProperty}和{@link  #withProperty}方法，例如：<pre class ="code"> {@code  PropertySource <？> source = new MockPropertySource（） .withProperty（"foo"，"bar"）; } </ pre> @author  Chris Beams @since 3.1 
 * @see  org.springframework.mock.env.MockEnvironment
 */
public class MockPropertySource extends PropertiesPropertySource {
	 ...
	 */
	/**
	 * 用给定的名称创建一个新的{@code  MockPropertySource}，并以给定的{@link  Properties}对象作为后盾。 
	 *  
	 * @param 命名属性源的{@link  plain #getName（）名称} 
	 * @param 属性以使用的属性
	 */
