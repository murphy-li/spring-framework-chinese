 ...
 */
/**
 * 简单的{@link  ConfigurableEnvironment}实现为测试目的公开了{@link  #setProperty（String，String）}和{@link  #withProperty（String，String）}方法。 
 *  @author 克里斯·比姆斯（Chris Beams）@author  Sam Brannen @since 3.2起
 * @see  org.springframework.mock.env.MockPropertySource
 */
public class MockEnvironment extends AbstractEnvironment {
	 ...
	 */
	/**
	 * 使用单个{@link  MockPropertySource}创建一个新的{@code  MockEnvironment}。 
	 * 
	 */
