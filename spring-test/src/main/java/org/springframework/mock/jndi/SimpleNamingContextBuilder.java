 ...
 * @see  org.springframework.jdbc.datasource.DriverManagerDataSource @deprecated从Spring Framework 5.2开始不推荐使用，以支持第三方的完整解决方案，例如<a href ="https://github.com / h-thurow / Simple-JNDI">简单JNDI </a>
 */
@Deprecated
