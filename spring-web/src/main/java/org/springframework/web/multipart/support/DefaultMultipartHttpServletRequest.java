 ...
 *  @author  Trevor D. Cook @author  Juergen Hoeller @author  Arjen Poutsma @自29.09.2003 
 * @see  org.springframework.web.multipart.MultipartResolver
 */
public class DefaultMultipartHttpServletRequest extends AbstractMultipartHttpServletRequest {
	 ...
	 *  
	 * @param 请求servlet请求包装
	 * @param  mpFiles多部分文件的映射
	 * @param  mpParams要公开的参数的映射，其中Strings作为键，String数组作为值
	 */
	 ...
	 */
	/**
	 * 获取要检索的多部分参数Map，如有必要，请对其进行延迟初始化。 
	 *  
	 * @see  #initializeMultipart（）
	 */
	 ...
	 */
	/**
	 * 获取用于检索的多部分参数内容类型Map，如有必要，请对其进行延迟初始化。 
	 *  
	 * @see  #initializeMultipart（）
	 */
