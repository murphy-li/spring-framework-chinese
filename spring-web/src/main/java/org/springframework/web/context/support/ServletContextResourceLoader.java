 ...
 */
/**
 * ResourceLoader实现，将路径解析为ServletContext资源，供在WebApplicationContext外部使用（例如，在HttpServletBean或GenericFilterBean子类中）。 
 *  <p>在WebApplicationContext中，上下文实现将资源路径自动解析为ServletContext资源。 
 *  @author  Juergen Hoeller @since 1.0.2起参见> org.springframework.web.filter.GenericFilterBean
 */
public class ServletContextResourceLoader extends DefaultResourceLoader {
	 ...
	 *  
	 * @param  servletContext ServletContext用来加载资源
	 */
