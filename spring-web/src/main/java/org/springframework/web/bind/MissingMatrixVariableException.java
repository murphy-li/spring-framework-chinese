 ...
 */
/**
 * {@link  ServletRequestBindingException}子类，它指示从URL提取的矩阵变量中不存在{@code  @RequestMapping}方法的方法参数中期望的矩阵变量。 
...
public class MissingMatrixVariableException extends ServletRequestBindingException {
	 ...
	 */
	/**
	 * MissingMatrixVariableException的构造方法。 
	 *  
	 * @param  variableName缺少矩阵变量的名称
	 * @param 参数方法参数
	 */
