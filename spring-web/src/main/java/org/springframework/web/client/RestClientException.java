 ...
 */
/**
 * 由{@link  RestTemplate}引发的异常的基类，以防由于服务器错误响应而导致请求失败（由{@link  ResponseErrorHandler＃hasError（ClientHttpResponse）}确定），解码响应失败或响应低级别的I / O错误。 
...
public class RestClientException extends NestedRuntimeException {
	 ...
	 */
	/**
	 * 使用给定的消息构造{@code  RestClientException}的新实例。 
	 *  
	 * @param 信息消息
	 */
	 ...
	 */
	/**
	 * 使用给定的消息和异常构造{@code  RestClientException}的新实例。 
	 *  
	 * @param 消息
	 * @param 消息除外
	 */
