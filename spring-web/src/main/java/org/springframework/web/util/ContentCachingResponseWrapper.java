 ...
 */
/**
 * {@link  javax.servlet.http.HttpServletResponse}包装器，用于缓存写入{{@link> plain #getOutputStream（）输出流}和{@link  plain #getWriter（）writer}的所有内容，并允许可以通过{@link  #getContentAsByteArray（）字节数组}检索此内容。 
 *  <p>使用例如由{@link  org.springframework.web.filter.ShallowEtagHeaderFilter}创建。 
 * 注意：从Spring Framework 5.0开始，此包装器基于Servlet 3.1 API构建。 
 *  @author  Juergen Hoeller @始于4.1.3 
 * @see  ContentCachingRequestWrapper
 */
public class ContentCachingResponseWrapper extends HttpServletResponseWrapper {
	...
	/**
	 * 返回响应上指定的状态码。 
	 *  @从5.2开始不推荐使用{@link  HttpServletResponse＃getStatus（）}
	 */
	@Deprecated
	 ...
	 * 将缓存的正文内容复制到响应中。 
	 *  
	 * @param  complete是否从4.2开始就为完整的缓存主体内容设置相应的内容长度
	 */
