 ...
 */
/**
 * 建立在{@link  PathPatternParser}上的{@code  RouteMatcher}，使用{@link  PathContainer}和{@link  PathPattern}作为已解析的路由和模式表示。 
...
public class PathPatternRouteMatcher implements RouteMatcher {
	 ...
	 */
	/**
	 * 为{@link  org.springframework.http.server.PathContainer.Options＃MESSAGE_ROUTE MESSAGE_ROUTE}自定义的{@link  PathPatternParser}的默认构造函数，但不匹配结尾的分隔符。 
	 * 
	 */
	 ...
	 */
	/**
	 * 具有给定的{@link  PathPatternParser}的构造方法。 
	 * 
	 */
