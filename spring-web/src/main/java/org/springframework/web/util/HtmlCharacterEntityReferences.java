 ...
 */
/**
 * 表示一组由HTML 4.0标准定义的字符实体引用。 
 *  <p>可以在https://www.w3.org/TR/html4/charset.html上找到HTML 4.0字符集的完整说明。 
 *  @author  Juergen Hoeller @author  Martin Kersten @author  Craig Andrews @1.2.1起
 */
class HtmlCharacterEntityReferences {
	 ...
	 */
	/**
	 * 返回映射到给定字符的引用，如果找不到，则返回{@code  null}。 
	 * 
	 */
	@Nullable
	 ...
	 */
	/**
	 * 返回映射到给定的entityReference或-1的char。 
	 * 
	 */
