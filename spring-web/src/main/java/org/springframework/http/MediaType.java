 ...
 *  @author  Arjen Poutsma @author  Juergen Hoeller @author  Rossen Stoyanchev @author  Sebastien Deleuze @author 清水一树@author  Sam Brannen @since 3.0 
 * @see  <a href ="https： //tools.ietf.org/html/rfc7231#section-3.1.1.1"> HTTP 1.1：语义和内容，第3.1.1.1节</a>
 */
 ...
 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃APPLICATION_ATOM_XML}的字符串。 
	 * 
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃APPLICATION_CBOR}的字符串。 
	 *  @5.2起
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃APPLICATION_FORM_URLENCODED}的字符串。 
	 * 
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃APPLICATION_JSON}的字符串。 
	 *  
	 * @see ＃APPLICATION_JSON_UTF8_VALUE
	 */
	 ...
	 * 从5.2版开始，不推荐使用{@link  #APPLICATION_JSON}，因为像Chrome这样的主要浏览器<a href="https://bugs.chromium.org/p/chromium/issues/detail?id=438464">现在符合规范</a>并正确解释UTF-8特殊字符，而无需使用{@code  charset = UTF-8}参数。 
	 * 
	 */
	@Deprecated
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃APPLICATION_JSON_UTF8}的字符串。 
	 * 从5.2版开始，不推荐使用{@link  #APPLICATION_JSON_VALUE}，因为现在主要的浏览器，例如Chrome <a href="https://bugs.chromium.org/p/chromium/issues/detail?id=438464">符合规范</a>并正确解释UTF-8特殊字符，而无需使用{@code  charset = UTF-8}参数。 
	 * 
	 */
	@Deprecated
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃APPLICATION_OCTET_STREAM}的字符串。 
	 * 
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃APPLICATION_PDF}的字符串。 
	 *  @4.3起
	 */
	 ...
	 *  @since 5.0 
	 * @see  <a href="https://tools.ietf.org/html/rfc7807#section-6.1"> HTTP API 6.1的问题详细信息。 
	 * 应用程序/问题+ json </a>
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃APPLICATION_PROBLEM_JSON}的字符串。 
	 *  @5.0起
	 */
	 ...
	 *  @since 5.0 
	 * @see  <a href="https://tools.ietf.org/html/rfc7807#section-6.1"> HTTP API 6.1的问题详细信息。 
	 * 自5.2起，不推荐使用application / problem + json </a>，而推荐使用{@link  #APPLICATION_PROBLEM_JSON}，因为主要的浏览器如Chrome <a href ="https://bugs.chromium.org/p/chromium/issues / detail？id = 438464">现在符合规范</a>，并且可以正确解释UTF-8特殊字符，而无需使用{@code  charset = UTF-8}参数。 
	 * 
	 */
	@Deprecated
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃APPLICATION_PROBLEM_JSON_UTF8}的字符串。 
	 *  @since 5.0 @从5.2开始不推荐使用{@link  #APPLICATION_PROBLEM_JSON_VALUE}，因为主要的浏览器如Chrome <a href ="https://bugs.chromium.org/p/chromium/issues/detail?id=438464 ">现在符合规范</a>，并且可以正确解释UTF-8特殊字符，而无需使用{@code  charset = UTF-8}参数。 
	 * 
	 */
	@Deprecated
	 ...
	 *  @since 5.0 
	 * @see  <a href="https://tools.ietf.org/html/rfc7807#section-6.2"> HTTP API 6.2的问题详细信息。 
	 * 应用程序/问题+ xml </a>
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃APPLICATION_PROBLEM_XML}的字符串。 
	 *  @5.0起
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃APPLICATION_RSS_XML}的字符串。 
	 *  @自4.3.6起
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃APPLICATION_STREAM_JSON}的字符串。 
	 *  @5.0起
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃APPLICATION_XHTML_XML}的字符串。 
	 * 
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃APPLICATION_XML}的字符串。 
	 * 
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃IMAGE_GIF}的字符串。 
	 * 
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃IMAGE_JPEG}的字符串。 
	 * 
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃IMAGE_PNG}的字符串。 
	 * 
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃MULTIPART_FORM_DATA}的字符串。 
	 * 
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃MULTIPART_MIXED}的字符串。 
	 *  @5.2起
	 */
	 ...
	 */
	/**
	 * {@code 文本/事件流}的公共常量媒体类型。 
	 *  @since 4.3.6 
	 * @see  <a href="https://www.w3.org/TR/eventsource/">服务器发送的事件W3C建议</a>
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃TEXT_EVENT_STREAM}的字符串。 
	 *  @自4.3.6起
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃TEXT_HTML}的字符串。 
	 * 
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃TEXT_MARKDOWN}的字符串。 
	 *  @4.3起
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃TEXT_PLAIN}的字符串。 
	 * 
	 */
	 ...
	 */
	/**
	 * 等效于{@link  MediaType＃TEXT_XML}的字符串。 
	 * 
	 */
	 ...
	 *  <p> {<@link>普通#getSubtype（）子类型}设置为"*"，参数为空。 
	 *  
	 * @param 键入主要类型
	 ...
	 * @param 其他其他媒体类型
	 * @param 字符集字符集
	 * @throws  IllegalArgumentException如果任何参数包含自4.3起的非法字符
	 */
	 ...
	 */
	/**
	 * 复制构造函数，用于复制给定{@code  MediaType}的类型和子类型，并允许使用不同的参数。 
	 *  
	 * @param 其他其他媒体类型
	 * @param 参数的参数，可以为{@code  null} 
	 * @throws  IllegalArgumentException如果任何参数包含非法字符
	 */
	 ...
	 */
	/**
	 * 指示此{@code  MediaType}是否包括给定的媒体类型。 
	 *  <p>例如，{<@code>文本}包括{@code 文本/纯文本}和{@code 文本/ html}，而{@code 应用程序+ xml}包括{@code  application / soap + xml}等。 
	 * 此方法<b>不</ b>不对称。 
	 *  <p>仅调用{@link  MimeType＃includes（MimeType）}，但使用{@code  MediaType}参数进行声明，以实现二进制向后兼容性。 
	 *  
	 * @param 其他与之比较的参考媒体类型
	 * @return  {@code  true}（如果此媒体类型包括给定的媒体类型）； 
	 *  {@code  false}否则
	 */
	 ...
	 *  <p>仅调用{@link  MimeType＃isCompatibleWith（MimeType）}，但使用{@code  MediaType}参数进行声明，以实现二进制向后兼容性。 
	 *  
	 * @param 其他与之比较的参考媒体类型
	 * @return  {@code  true}（如果此媒体类型与给定的媒体类型兼容）； 
	 *  {@code  false}否则
	 */
	 ...
	 */
	/**
	 * 返回具有给定的{@code  MediaType}的质量值的该实例的副本。 
	 *  
	 * @return 如果给定的MediaType没有质量值，则为同一实例，否则为新实例
	 */
	 ...
	 */
	/**
	 * 将给定的String值解析为{@code  MediaType}对象，此方法名称遵循'valueOf'命名约定（受{@link  org.springframework.core.convert.ConversionService}支持。 
	 *  >如果无法解析媒体类型值，则为要解析的字符串
	 ...
	 *  
	 * @param  mediaType要解析的字符串
	 * @return 媒体类型
	 * @throws 如果媒体类型的值无法解析，则InvalidMediaTypeException
	 */
	 ...
	 */
	/**
	 * 将逗号分隔的字符串解析为{@code  MediaType}对象的列表。 
	 *  <p>此方法可用于解析Accept或Content-Type标头。 
	 *  
	 * @param  mediaTypes解析的字符串
	 * @return 媒体类型列表
	 * @throws  InvalidMediaTypeException如果无法解析媒体类型值
	 */
	 ...
	 */
	/**
	 * 将给定的（可能）逗号分隔的字符串列表解析为{@code  MediaType}对象的列表。 
	 *  <p>此方法可用于解析Accept或Content-Type标头。 
	 *  
	 * @param  mediaType输入要解析的字符串
	 * @return 媒体类型列表
	 * @throws  InvalidMediaTypeException如果无法解析媒体类型值，则自4.3.2起
	 */
	 ...
	 */
	/**
	 * 返回{@code  MediaType}对象的给定列表的字符串表示形式。 
	 *  <p>此方法可用于{@code  Accept}或{@code  Content-Type}标头。 
	 *  
	 * @param  mediaType设置媒体类型以为
	 * @return 字符串表示形式创建字符串表示形式
	 */
	 ...
	 */
	/**
	 * 按特异性对{@code  MediaType}对象的给定列表进行排序。 
	 *  <p>给出两种媒体类型：<ol> <li>如果任何一种媒体类型都具有{@link  plain #isWildcardType（）通配符类型}，则没有通配符的媒体类型将在另一种之前排序。 
	 * </ li > <li>如果两种媒体类型具有不同的{@link  plain #getType（）类型}，则它们将被视为相等并保持其当前顺序。 
	 * </ li> <li>如果任何一种媒体类型具有{ @link> plain #isWildcardSubtype（）通配符子类型}，然后将不含通配符的媒体类型排在另一个之前。 
	 * </ li> <li>如果两种媒体类型具有不同的{@link  plain #getSubtype（）子类型}，则它们被视为相等并保持其当前顺序。 
	 * </ li> <li>如果两种媒体类型具有不同的{@link  plain #getQualityValue（）质量值}，则质量值最高的媒体类型</ li> <li>如果两种媒体类型具有不同数量的{@link  plain #getParameter（String）parameters}，则具有最多参数的媒体类型将优先于另一种</ li> </ ol> <p>例如：<blockquote> audio / basic <音频</ </ blockquote> <blockquote> audio <音频; q = 0.7;音频; q = 0.3 </ blockquote> <blockquote>音频/基本; level = 1 <音频/基本</ blockquote> <blockquote>音频/基本==文本/ html </ blockquote> <blockquote>音频/基本== audio / wave </ blockquote> 
	 * @param  mediaTypes列出要排序的媒体类型列表
	 ...
	 */
	/**
	 * 按质量值对{@code  MediaType}对象的给定列表进行排序。 
	 *  <p>给出两种介质类型：<ol> <li>如果两种介质类型具有不同的{@link  plain #getQualityValue（）质量值}，则在其他介质类型之前，对质量最高的介质类型进行排序。 
	 *  </ li> <li>如果任何一种媒体类型都具有{@link  plain #isWildcardType（）通配符类型}，则没有通配符的媒体类型将在另一种之前排序。 
	 * </ li> <li>如果两者媒体类型具有不同的{@link  plain #getType（）类型}，则它们被认为是相等的，并保持其当前顺序。 
	 * </ li> <li>如果任一媒体类型具有{@link  plain #isWildcardSubtype（ ），然后将没有通配符的媒体类型排在另一个之前。 
	 * </ li> <li>如果两种媒体类型具有不同的{@link  plain #getSubtype（）子类型}，则它们被认为是相等的并保持其当前顺序。 
	 * </ li> <li>如果两种媒体类型具有不同数量的{@link  plain #getParameter（String）parameters}，则具有最多参数的媒体类型将排在其他媒体之前</ li> </ ol> 
	 * @param  mediaTypes列出要排序的媒体类型列表
	 * @see  #getQualityValue（）
	 */
	 ...
	 */
	/**
	 * 按特定性对给定的{@code  MediaType}对象列表进行分类，将其作为主要标准，将质量值作为次要标准。 
	 *  
	 * @see  MediaType＃sortBySpecificity（列表）
	 * @see  MediaType＃sortByQualityValue（列表）
	 */
...
/**
 * ; q = 0.7 <audio; q = 0.3}否则if（mediaType1.isWildcardType（）&&！ 
...
/**
 * <音频/基本返回1； 
 *  }否则，如果（mediaType2.isWildcardSubtype（）&&！ 
 * mediaType1.isWildcardSubtype（））{//音频/基本>音频返回-1; }否则if（！ 
 * mediaType1.getSubtype（）。 
 * equals（mediaType2.getSubtype（）））{//音频/基本==音频/波形返回0； 
 *  } else {int paramsSize1 = mediaType1.getParameters（）。 
 * size（）; int paramsSize2 = mediaType2.getParameters（）。 
 * size（）;返回Integer.compare（paramsSize2，paramsSize1）; //音频/基本； 
 * 级别= 1 <音频/基本}}}; {@link  #sortBySpecificity（List）}使用的比较器。 
 * 
 */
