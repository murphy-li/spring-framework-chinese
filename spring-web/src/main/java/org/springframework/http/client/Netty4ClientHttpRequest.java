 ...
 *  @author  Arjen Poutsma @author  Rossen Stoyanchev @author  Brian Clozel @since 4.1.2 @从Spring 5.0开始不推荐使用，而推荐使用{@link  org.springframework.http.client.reactive.ReactorClientHttpConnector}
 */
@Deprecated
class Netty4ClientHttpRequest extends AbstractAsyncClientHttpRequest implements ClientHttpRequest {
	 ...
	 */
	/**
	 * 一个SimpleChannelInboundHandler，用于更新给定的SettableListenableFuture。 
	 * 
	 */
