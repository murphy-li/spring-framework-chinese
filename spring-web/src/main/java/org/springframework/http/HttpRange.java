 ...
 */
/**
 * 表示与HTTP {@code "Range"}标头一起使用的HTTP（字节）范围。 
 *  @author  Arjen Poutsma @author  Juergen Hoeller @始于4.2 
 * @see  <a href="https://tools.ietf.org/html/rfc7233"> HTTP / 1.1：范围请求</a> 
...
public abstract class HttpRange {
	 ...
	 *  
	 * @param 资源{@code 资源}以从
	 * @return 给定{@code 资源}的选定区域中选择区域，从4.3开始
	 */
	 ...
	 */
	/**
	 * 从给定位置到末尾创建一个{@code  HttpRange}。 
	 *  
	 * @param  firstBytePos第一个字节位置
	 * @return 一个字节范围，从{@code  firstPos}到末尾
	 ...
	 */
	/**
	 * 从给定的拳头到最后一个位置创建一个{@code  HttpRange}。 
	 *  
	 * @param  firstBytePos第一个字节位置
	 * @param  lastBytePos最后一个字节位置
	 ...
	 */
	/**
	 * 创建一个{@code  HttpRange}，其范围为最后给定的字节数。 
	 *  
	 * @param  suffixLength范围内的字节数
	 * @return 一个字节范围，其范围为最后一个{@code  suffixLength}字节数
	 * @see  <a href ="https：//tools.ietf .org / html / rfc7233＃section-2.1">字节范围</a>
	 */
	 ...
	 */
	/**
	 * 将给定的逗号分隔的字符串解析为{@code  HttpRange}对象的列表。 
	 *  <p>此方法可用于解析{@code  Range}标头。 
	 *  
	 * @param 范围内要解析的字符串
	 * @return 范围列表
	 * @throws  IllegalArgumentException如果无法解析该字符串或范围数大于100
	 */
	 ...
	 */
	/**
	 * 将每个{@code  HttpRange}转换为{@code  ResourceRegion}，并使用HTTP Range信息选择给定{{@@code> Resource}的适当段。 
	 *  
	 * @param 将范围列表作为
	 * @param 资源的资源，以从
	 * @return 中为给定资源的区域列表选择区域
	 * @throws  IllegalArgumentException如果所有范围的总和超过了资源长度@since 4.3
	 */
	 ...
	 */
	/**
	 * 返回{@code  HttpRange}对象的给定列表的字符串表示形式。 
	 ...
	 */
	/**
	 * 表示一个HTTP / 1.1字节范围，具有第一个和可选的最后一个位置。 
	 *  
	 * @see  <a href="https://tools.ietf.org/html/rfc7233#section-2.1">字节范围</a> 
	 * @see  HttpRange＃createByteRange（long）
	 * @see  HttpRange＃ createByteRange（long，long）
	 ...
	 */
	/**
	 * 表示一个HTTP / 1.1后缀字节范围，带有多个后缀字节。 
	 *  
	 * @see  <a href="https://tools.ietf.org/html/rfc7233#section-2.1">字节范围</a> 
	 * @see  HttpRange＃createSuffixRange（长）
	 */
