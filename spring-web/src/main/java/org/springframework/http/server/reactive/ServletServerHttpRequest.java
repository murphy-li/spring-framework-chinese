 ...
 */
/**
 * 使{@link  ServerHttpRequest}适应Servlet {@link  HttpServletRequest}。 
...
class ServletServerHttpRequest extends AbstractServerHttpRequest {
	 ...
	 */
	/**
	 * 从请求主体InputStream读取并返回一个DataBuffer。 
	 * 仅在{@link  ServletInputStream＃isReady（）}返回"true"时调用。 
	 *  
	 * @return 读取了数据的DataBuffer，如果输入流返回-1，则返回{@link  #EOF_BUFFER}，如果读取0字节，则返回null。 
	 * 
	 */
	@Nullable
