 ...
 */
/**
 * 使{@link  ServerHttpResponse}适应Servlet {@link  HttpServletResponse}。 
...
class ServletServerHttpResponse extends AbstractListenerServerHttpResponse {
	 ...
	 */
	/**
	 * 将DataBuffer写入响应主体OutputStream。 
	 * 仅在{@link  ServletOutputStream＃isReady（）}返回"true"并且DataBuffer中的可读字节大于0时调用。 
	 * 
	 * @return 写入的字节数
	 */
