 ...
 *  @author  Rossen Stoyanchev @author 塞巴斯蒂安·德勒兹（Sebastien Deleuze）
 */
class BaseDefaultCodecs implements CodecConfigurer.DefaultCodecs, CodecConfigurer.DefaultCodecConfig {
	 ...
	 */
	/**
	 * 从{@link  BaseCodecConfigurer＃registerDefaults}使用的委托方法。 
	 * 
	 */
	 ...
	 */
	/**
	 * 如果应用程序配置了{{@link> #maxInMemorySize（）}和{@link  #enableLoggingRequestDetails}，则将其应用于给定的编解码器，包括其包含的任何编解码器。 
	 * 
	 */
