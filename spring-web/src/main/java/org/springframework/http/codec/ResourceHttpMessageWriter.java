 ...
 */
/**
 * 可以编写{@link 资源}的{@code  HttpMessageWriter}。 
 *  <p>也是{@code  HttpMessageWriter}的实现，支持根据请求中指定的HTTP范围编写一个或多个{@link  ResourceRegion}。 
 *  <p>要读取资源，请使用{@link  DecoderHttpMessageReader}包装的{@link  ResourceDecoder}。 
 *  @author  Arjen Poutsma @author  Brian Clozel @author  Rossen Stoyanchev @从5.0开始
 * @see  ResourceEncoder 
 * @see  ResourceRegionEncoder 
 * @see  HttpRange
 */
