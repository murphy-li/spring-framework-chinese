 ...
 */
/**
 * {@link  org.springframework.http.converter.HttpMessageConverter}的实现，可以读写RSS feed。 
 * 具体来说，此转换器可以处理<a href="https://github.com/rometools/rome"> ROME </a>项目中的{@link  Channel}对象。 
 *  <p >> <b>注意：从Spring 4.1开始，它基于ROME 1.5版的{@code  com.rometools}变体。 
 * 请升级您的构建依赖项。 
 * </ b> <p>默认情况下，此转换器读取和写入媒体类型（{@code  application / rss + xml}）。 
