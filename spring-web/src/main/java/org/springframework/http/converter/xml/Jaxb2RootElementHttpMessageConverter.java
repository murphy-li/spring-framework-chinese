 ...
 *  <p>此转换器可以读取用{@link  XmlRootElement}和{@link  XmlType}注释的类，并可以编写用{@link  XmlRootElement}注释的类或其子类。 
 *  <p>注意：当使用来自{@code  spring-oxm}的Spring的Marshaller / Unmarshaller抽象时，您应该改为使用{@link  MarshallingHttpMessageConverter}。 
 *  @author  Arjen Poutsma @author 塞巴斯蒂安·德勒兹（Sebastien Deleuze）@author  Rossen Stoyanchev @since 3.0 
 * @see  MarshallingHttpMessageConverter
 */
