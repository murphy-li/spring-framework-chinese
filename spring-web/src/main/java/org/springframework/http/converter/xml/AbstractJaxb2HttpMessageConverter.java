...
public abstract class AbstractJaxb2HttpMessageConverter<T> extends AbstractXmlHttpMessageConverter<T> {
	 ...
	 * @throws  HttpMessageConversionException创建
	 * @return 编组器
	 */
	 ...
	 */
	/**
	 * 在使用该消息转换器将对象写入输出之前，请自定义由此消息转换器创建的{@link  Marshaller}。 
	 *  
	 * @param  marshaller marshaller自4.0.3起自定义@
	 * @see> #createMarshaller（Class）
	 */
	 ...
	 *  
	 * @param 取消编组取消编组以自定义@since 4.0.3 
	 * @see  #createUnmarshaller（Class）
	 */
	 ...
	 * @throws  HttpMessageConversionException的上下文，如果发生JAXB错误
	 */
