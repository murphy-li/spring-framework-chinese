 ...
 */
/**
 * 用于基于Jackson和与内容类型无关的{@link  HttpMessageConverter}实现的抽象基类。 
 *  <p>从Spring 5.0开始，与Jackson 2.9和更高版本兼容。 
 *  @author  Arjen Poutsma @author  Keith Donald @author  Rossen Stoyanchev @author  Juergen Hoeller @author 塞巴斯蒂安·德勒兹（Sebastien Deleuze）@自4.1起
 * @see  MappingJackson2HttpMessageConverter
 */
public abstract class AbstractJackson2HttpMessageConverter extends AbstractGenericHttpMessageConverter<Object> {
	 ...
	 *  
	 * @param 输入泛型类型以返回
	 * @param  contextClass的Jackson JavaType作为目标类型的上下文类，例如，目标类型出现在方法签名中的类（可以为{@code  null }）
