 ...
 */
/**
 * 工厂用于根据使用的数据库类型创建{@link  TableMetaDataProvider}实现。 
...
public final class TableMetaDataProviderFactory {
	 ...
	 */
	/**
	 * 根据数据库元数据创建一个{@link  TableMetaDataProvider}。 
	 *  
	 * @param  dataSource用于检索元数据
	 * @param 上下文，该类保存要使用的TableMetaDataProvider实现的配置和元数据
	 * @return 实例
	 */
