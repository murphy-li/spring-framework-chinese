 ...
 */
/**
 * 基于临时LOB的{@link  LobCreator}实现，使用JDBC 4.0的{@link  java.sql.Connection＃createBlob（）} / {@link  java.sql.Connection＃createClob（）}机制。 
 *  <p>由DefaultLobHandler的{@link  DefaultLobHandler＃setCreateTemporaryLob}模式使用。 
 * 也可以直接用于重用临时LOB的跟踪和释放。 
 *  @author  Juergen Hoeller @since 3.2.2 
 * @see  DefaultLobHandler＃setCreateTemporaryLob 
 * @see  java.sql.Connection＃createBlob（）
 * @see  java.sql.Connection＃createClob（）
 */
