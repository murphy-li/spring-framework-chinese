 ...
 */
/**
 * {@link  DataFieldMaxValueIncrementer}检索DB2 LUW上给定序列的下一个值（对于Linux，Unix和Windows）。 
 *  <p>感谢Mark MacMahon的建议！ 
 *  @author  Juergen Hoeller从1.1.3版本开始，@不再推荐使用专门命名的{@link  Db2LuwMaxValueIncrementer}
 */
@Deprecated
