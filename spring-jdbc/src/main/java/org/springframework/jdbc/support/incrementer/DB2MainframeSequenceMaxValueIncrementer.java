 ...
 */
/**
 * {@link  DataFieldMaxValueIncrementer}检索大型机（z / OS，DB2 / 390，DB2 / 400）在DB2上给定序列的下一个值。 
 *  <p>感谢Jens Eickmeyer的建议！ 
 *  @author 于尔根·霍勒（Juergen Hoeller）@自2.5.3起@不赞成使用以其他方式命名的{@link  Db2MainframeMaxValueIncrementer}
 */
@Deprecated
