 ...
 */
/**
 * Spring的{@link  SqlRowSetMetaData}接口的默认实现，包装一个{@link  java.sql.ResultSetMetaData}实例，捕获任何{@link  SQLException SQLExceptions}并将其转换为相应的Spring {<@link > InvalidResultSetAccessException}。 
 *  <p>由{@link  ResultSetWrappingSqlRowSet}使用。 
 *  @author 托马斯·里斯伯格@author  Juergen Hoeller @始于1.2 
 * @see  ResultSetWrappingSqlRowSet＃getMetaData（）
 */
public class ResultSetWrappingSqlRowSetMetaData implements SqlRowSetMetaData {
	 ...
	 */
	/**
	 * 为给定的ResultSetMetaData实例创建一个新的ResultSetWrappingSqlRowSetMetaData对象。 
	 *  
	 * @param  resultSetMetaData要包装的断开连接的ResultSetMetaData实例（通常是一个{@code  javax.sql.RowSetMetaData}实例）
	 * @see  java.sql.ResultSet＃getMetaData 
	 * @see  javax.sql.RowSetMetaData <
	 * @see > ResultSetWrappingSqlRowSet＃getMetaData
	 */
