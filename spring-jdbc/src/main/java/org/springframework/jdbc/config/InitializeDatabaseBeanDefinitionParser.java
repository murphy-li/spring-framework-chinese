 ...
 */
/**
 * {@link  org.springframework.beans.factory.xml.BeanDefinitionParser}解析一个{@code  initialize-database}元素并创建一个{@link  DataSourceInitializer}类型的{@link  BeanDefinition}。 
 * 拾取嵌套的{@code 脚本}元素，并为它们配置{@link  ResourceDatabasePopulator}。 
 *  @author  Dave Syer @author 于尔根·霍勒（Juergen Hoeller）@从3.0开始
 */
