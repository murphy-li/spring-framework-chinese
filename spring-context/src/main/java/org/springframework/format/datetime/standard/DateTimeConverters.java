 ...
 */
/**
 * 安装将JSR-310支持集成到Spring的字段格式系统中所需的下层类型转换器。 
 *  <p>注意：{@link  DateTimeFormatterRegistrar}安装这些转换器，但不依赖于它们作为其格式器。 
 * 它们只是为不同JSR-310值类型之间以及{@link  java.util.Calendar}和JSR-310值类型之间的自定义转换方案注册的。 
