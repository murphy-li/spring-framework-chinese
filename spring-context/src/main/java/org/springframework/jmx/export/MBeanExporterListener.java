 ...
 */
/**
 * 一个侦听器，当通过{@link  MBeanExporter}注册和取消注册MBean时，允许通知应用程序代码。 
 *  @author 罗布·哈罗普（Rob Harrop）@从1.2.2开始
 * @see  org.springframework.jmx.export.MBeanExporter＃setListeners
 */
public interface MBeanExporterListener {
	 ...
	 */
	/**
	 * 在<i>成功</ i>向{@link  javax.management.MBeanServer}注册了MBean后，由{@link  MBeanExporter}调用。 
	 *  
	 ...
	 */
	/**
	 * 在成功从{@link  javax.management.MBeanServer}中取消注册MBean之后，由{@link  MBeanExporter}调用。 
	 *  
