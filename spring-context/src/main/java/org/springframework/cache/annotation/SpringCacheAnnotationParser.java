 ...
 */
/**
 * 解析Spring的{@link 缓存}，{<@link> Cacheable}，{<@link> CacheEvict}和{@link  CachePut}注解的策略实现。 
 *  @author  Costin Leau @author  Juergen Hoeller @author 克里斯·比姆斯（Chris Beams）@author  Phillip Webb @author  Stephane Nicoll @author  Sam Brannen @since 3.1
 */
...
public class SpringCacheAnnotationParser implements CacheAnnotationParser, Serializable {
	 ...
	 *  <p>如果操作状态无效，则引发{@link  IllegalStateException}。 
	 * 由于默认值可能有多个来源，因此请确保在返回操作之前，该操作处于正确的状态。 
	 *  
	 * @param 是缓存操作
	 * @param 操作的注释元素，{@@link> CacheOperation}进行验证
	 */
