 ...
 */
/**
 * 根据导入的{@code  @Configuration}类上的{@link  EnableCaching＃mode}的值，选择应使用{@link  AbstractCachingConfiguration}的实现。 
 *  <p>检测到JSR-107的存在并相应地启用JCache支持。 
...
public class CachingConfigurationSelector extends AdviceModeImportSelector<EnableCaching> {
	 ...
	 */
	/**
	 * 分别为{@link  EnableCaching＃mode（）}的{@code  PROXY}和{@code  ASPECTJ}值返回{{@link> ProxyCachingConfiguration}或{@code  AspectJCachingConfiguration}。 
	 * 可能还包括相应的JCache配置。 
	 * 
	 */
	@Override
