 ...
 */
/**
 * 独立XML应用程序上下文，它从类路径中获取上下文定义文件，将纯路径解释为包含包路径的类路径资源名称（例如"mypackage / myresource.txt"）。 
 * 对于测试工具以及嵌入在JAR中的应用程序上下文很有用。 
 *  <p>可以通过{@link  #getConfigLocations}覆盖配置位置的默认值，配置位置可以表示"/myfiles/context.xml"之类的具体文件，也可以表示"/ myfiles -context.xml"之类的Ant样式模式。 
 *  （有关模式的详细信息，请参见{@link  org.springframework.util.AntPathMatcher} Javadoc）。 
...
public class ClassPathXmlApplicationContext extends AbstractXmlApplicationContext {
	 ...
	 */
	/**
	 * 使用给定的父级创建一个新的ClassPathXmlApplicationContext，从给定的XML文件中加载定义，并自动刷新上下文。 
	 *  
	 * @param 资源位置的configLocations数组
	 * @param 父级父级上下文
	 * @throws  BeansException如果上下文创建失败
	 ...
	 * 为了获得充分的灵活性，请考虑将GenericApplicationContext与XmlBeanDefinitionReader和ClassPathResource参数一起使用。 
	 *  
	 * @param 路径类路径中的相对（或绝对）路径
	 * @param 使类加载类（给定路径的基础）上的资源
	 * @throws  BeansException如果上下文创建失败
	 * @see  org.springframework。 
	 *  core.io.ClassPathResource＃ClassPathResource（String，Class）
	 * @see  org.springframework.context.support.GenericApplicationContext 
	 * @see  org.springframework.beans.factory.xml.XmlBeanDefinitionReader
	 */
	 ...
	 * @throws  BeansException如果上下文创建失败
	 * @see  org。 
	 *  springframework.core.io.ClassPathResource＃ClassPathResource（String，Class）
	 * @see  org.springframework.context.support.GenericApplicationContext 
	 * @see  org.springframework.beans.factory.xml.XmlBeanDefinitionReader
	 */
	 ...
	 * 使用给定的父级创建一个新的ClassPathXmlApplicationContext，从给定的XML文件中加载定义，并自动刷新上下文。 
	 *  
	 * @param 在类路径中相对（或绝对）路径的路径数组
	 * @param 使类加载类（以给定路径为基础）来填充类
	 * @param 父级父级上下文
	 * @throws  BeansException if context创建失败
	 * @see  org.springframework.core.io.ClassPathResource＃ClassPathResource（String，Class）
	 * @see  org.springframework.context.support.GenericApplicationContext 
	 * @see  org.springframework.beans.factory.xml.XmlBeanDefinitionReader
	 */
