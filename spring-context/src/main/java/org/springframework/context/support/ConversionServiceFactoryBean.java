 ...
 * 子类可以重写{@link  #createConversionService（）}，以返回其选择的{@link  GenericConversionService}实例。 
 *  <p>类似于所有{@code  FactoryBean}实现，该类适合在使用Spring {@code  <beans>} XML配置Spring应用程序上下文时使用。 
 * 使用{@link  org.springframework.context.annotation.Configuration @Configuration}类配置容器时，只需实例化，配置并从{@link  org.springframework返回适当的{@code  ConversionService}对象.context.annotation.Bean @Bean}方法。 
...
public class ConversionServiceFactoryBean implements FactoryBean<ConversionService>, InitializingBean {
	 ...
	 */
	/**
	 * 配置应添加的自定义转换器对象集：实现{@link  org.springframework.core.convert.converter.Converter}，{<@link> org.springframework.core.convert.converter.ConverterFactory}或{@link  org.springframework.core.convert.converter.GenericConverter}。 
	 * 
	 */
