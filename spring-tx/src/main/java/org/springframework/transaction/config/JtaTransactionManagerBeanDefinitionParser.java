 ...
 */
/**
 * <tx：jta-transaction-manager /> XML配置元素的解析器，自动检测WebLogic和WebSphere服务器并公开相应的{@link  org.springframework.transaction.jta.JtaTransactionManager}子类。 
 *  @author  Juergen Hoeller @author  Christian Dupuis @since 2.5起
 * @see  org.springframework.transaction.jta.WebLogicJtaTransactionManager 
 * @see  org.springframework.transaction.jta.WebSphereUowTransactionManager
 */
