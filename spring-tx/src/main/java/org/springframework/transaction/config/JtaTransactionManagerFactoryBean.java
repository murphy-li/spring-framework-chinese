 ...
 */
/**
 * 一个与<tx：jta-transaction-manager /> XML元素等效的{@link  FactoryBean}，自动检测WebLogic和WebSphere服务器并公开相应的{@link  org.springframework.transaction.jta.JtaTransactionManager}子类。 
 *  @author  Juergen Hoeller @since 4.1.1 
 * @see  org.springframework.transaction.jta.WebLogicJtaTransactionManager 
 * @see  org.springframework.transaction.jta.WebSphereUowTransactionManager
 */
